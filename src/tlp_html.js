const tlp =
{
    ...
    "1.11": {
        ...
        "PearsMcGuinness": [
            "The world is determined by the facts, and by their being <em>all<\/em> the facts."
        ]
    },
    "1.12": {
        "German": [
    ...
    "2.012": {
        ...
        "PearsMcGuinness": [
            "In logic nothing is accidental: if a thing <em>can<\/em> occur in a state of affairs, the possibility of the state of affairs must be written into the thing itself."
        ]
    },
    "2.0121": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "Just as we are quite unable to imagine spatial objects outside space or temporal objects outside time, so too there is <em>no<\/em> object that we can imagine excluded from the possibility of combining with others.",
    ...
    "2.0122": {
        ...
        "PearsMcGuinness": [
            "Things are independent in so far as they can occur in all <em>possible<\/em> situations, but this form of independence is a form of connexion with states of affairs, a form of dependence. (It is impossible for words to appear in two different roles: by themselves, and in propositions.)"
        ]
    },
    "2.0123": {
        "German": [
    ...
    "2.0124": {
        ...
        "PearsMcGuinness": [
            "If all objects are given, then at the same time all <em>possible<\/em> states of affairs are also given."
        ]
    },
    "2.013": {
        "German": [
    ...
    "2.0131": {
        ...
        "PearsMcGuinness": [
            ...
            "A speck in the visual field, thought it need not be red, must have some colour: it is, so to speak, surrounded by colour-space. Notes must have <em>some<\/em> pitch, objects of the sense of touch <em>some<\/em> degree of hardness, and so on."
        ]
    },
    "2.014": {
        "German": [
    ...
    "2.022": {
        ...
        "PearsMcGuinness": [
            "It is obvious that an imagined world, however different it may be from the real one, must have <em>something<\/em>—a form—in common with it."
        ]
    },
    "2.023": {
        "German": [
    ...
    "2.0231": {
        ...
        "PearsMcGuinness": [
            "The substance of the world <em>can<\/em> only determine a form, and not any material properties. For it is only by means of propositions that material properties are represented—only by the configuration of objects that they are produced."
        ]
    },
    "2.0232": {
        "German": [
    ...
    "2.1511": {
        ...
        "PearsMcGuinness": [
            "<em>That<\/em> is how a picture is attached to reality; it reaches right out to it."
        ]
    },
    "2.1512": {
        "German": [
    ...
    "2.15121": {
        ...
        "PearsMcGuinness": [
            "Only the end-points of the graduating lines actually <em>touch<\/em> the object that is to be measured."
        ]
    },
    "2.1513": {
        "German": [
    ...
    "2.182": {
        ...
        "PearsMcGuinness": [
            "Every picture is <em>at the same time<\/em> a logical one. (On the other hand, not every picture is, for example, a spatial one.)"
        ]
    },
    "2.19": {
        "German": [
    ...
    "2.225": {
        ...
        "PearsMcGuinness": [
            "There are no pictures that are true <em>a priori<\/em>."
        ]
    },
    "3": {
        "German": [
    ...
    "3.031": {
        ...
        "PearsMcGuinness": [
            "It used to be said that God could create anything except what would be contrary to the laws of logic. The truth is that we could not <em>say<\/em> what an ‘illogical’ world would look like."
        ]
    },
    "3.032": {
        "German": [
    ...
    "3.04": {
        ...
        "PearsMcGuinness": [
            "If a thought were correct <em>a priori<\/em>, it would be a thought whose possibility ensured its truth."
        ]
    },
    "3.05": {
        "German": [
        ...
        "PearsMcGuinness": [
            "<em>A priori<\/em> knowledge that a thought was true would be possible only if its truth were recognizable from the thought itself (without anything to compare it with)."
        ]
    },
    "3.1": {
        "German": [
    ...
    "3.1432": {
        ...
        "PearsMcGuinness": [
            "Instead of, ‘The complex sign “<span class=\"mathmode\"><var>aRb<\/var><\/span>” says that <span class=\"mathmode\"><var>a<\/var><\/span> stands to <span class=\"mathmode\"><var>b<\/var><\/span> in\nthe relation <span class=\"mathmode\"><var>R<\/var><\/span>’, we ought to put, ‘<em>That<\/em> “<span class=\"mathmode\"><var>a<\/var><\/span>” stands to “<span class=\"mathmode\"><var>b<\/var><\/span>” in a certain\nrelation says <em>that<\/em> <span class=\"mathmode\"><var>aRb<\/var><\/span>.’"
        ]
    },
    "3.144": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Situations can be described but not <em>given names<\/em>.",
    ...
    "3.203": {
        ...
        "PearsMcGuinness": [
            "A name means an object. The object is its meaning. (‘<span class=\"mathmode\"><var>A<\/var><\/span>’ is the same sign as ‘<span class=\"mathmode\"><var>A<\/var><\/span>’.)"
        ]
    },
    "3.21": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The configuration of objects in a situation corresponds to the configuration of simple signs in the propositional sign."
        ]
    },
    "3.22": {
        "German": [
    ...
    "3.221": {
        ...
        "PearsMcGuinness": [
            "Objects can only be <em>named<\/em>. Signs are their representatives. I can only speak <em>about<\/em> them: I cannot <em>put them into words<\/em>. Propositions can only say <em>how<\/em> things are, not <em>what<\/em> they are."
        ]
    },
    "3.23": {
        "German": [
    ...
    "3.24": {
        ...
        "PearsMcGuinness": [
            ...
            "When a propositional element signifies a complex, this can be seen from an indeterminateness in the propositions in which it occurs. In such cases we <em>know<\/em> that the proposition leaves something undetermined. (In fact the notation for generality <em>contains<\/em> a prototype.)",
    ...
    "3.261": {
        ...
        "PearsMcGuinness": [
            "Every sign that has a definition signifies <em>via<\/em> the signs that serve to define it; and the definitions point the way.",
            "Two signs cannot signify in the same manner if one is primitive and the other is defined by means of primitive signs. Names <em>cannot<\/em> be anatomized by means of definitions. (Nor can any sign that has a meaning independently and on its own.)"
        ]
    },
    "3.262": {
        "German": [
    ...
    "3.312": {
        ...
        "PearsMcGuinness": [
            ...
            "In fact, in this form the expression will be <em>constant<\/em> and everything else <em>variable<\/em>."
        ]
    },
    "3.313": {
        "German": [
    ...
    "3.316": {
        ...
        "PearsMcGuinness": [
            ...
            "The stipulation of values <em>is<\/em> the variable."
        ]
    },
    "3.317": {
        "German": [
            ...
            "Und <em class=\"germph\">nur<\/em> dies ist der Festsetzung wesentlich, <em class=\"germph\">dass sie nur eine Beschreibung von Symbolen ist und nichts über das Bezeichnete aussagt<\/em>.",
        ...
        "PearsMcGuinness": [
            "To stipulate values for a propositional variable is to <em>give the propositions<\/em> whose common characteristic the variable is.",
            ...
            "And the <em>only<\/em> thing essential to the stipulation is <em>that it is merely a description of symbols and states nothing about what is signified<\/em>.",
    ...
    "3.322": {
        ...
        "PearsMcGuinness": [
            "Our use of the same sign to signify two different objects can never indicate a common characteristic of the two, if we use it with two different <em>modes of signification<\/em>. For the sign, of course, is arbitrary. So we could choose two different signs instead, and then what would be left in common on the signifying side?"
        ]
    },
    "3.323": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "Thus the word ‘is’ figures as the copula, as a sign for identity, and as an expression for existence; ‘exist’ figures as an intransitive verb like ‘go’, and ‘identical’ as an adjective; we speak of <em>something<\/em>, but also of <em>something’s<\/em> happening.",
            "(In the proposition, ‘Green is green’—where the first word is the proper name of a person and the last an adjective—these words do not merely have different meanings: they are <em>different symbols<\/em>.)"
        ]
    },
    "3.324": {
        "German": [
    ...
    "3.325": {
        ...
        "PearsMcGuinness": [
            "In order to avoid such errors we must make use of a sign-language that excludes them by not using the same sign for different symbols and by not using in a superficially similar way signs that have different modes of signification: that is to say, a sign-language that is governed by <em>logical<\/em> grammar—by logical syntax.",
    ...
    "3.327": {
        ...
        "PearsMcGuinness": [
            "A sign does not determine a logical form unless it is taken together with its logico-syntactical employment."
        ]
    },
    "3.328": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If a sign is <em>useless<\/em>, it is meaningless. That is the point of Occam’s maxim.",
    ...
    "3.33": {
        ...
        "PearsMcGuinness": [
            "In logical syntax the meaning of a sign should never play a role. It must be possible to establish logical syntax without mentioning the <em>meaning<\/em> of a sign: <em>only<\/em> the description of expressions may be presupposed."
        ]
    },
    "3.331": {
        "German": [
        ...
        "PearsMcGuinness": [
            "From this observation we turn to Russell’s ‘theory of types’. It can be seen that Russell must be wrong, because he had to mention the meaning of signs when establishing the rules for them."
        ]
    },
    "3.332": {
        "German": [
    ...
    "3.333": {
        ...
        "PearsMcGuinness": [
            ...
            "For let us suppose that the function <span class=\"mathmode\"><var>F<\/var>(<var>fx<\/var>)<\/span> could be its own argument: in that case there would be a proposition ‘<span class=\"mathmode\"><var>F<\/var>(<var>F<\/var>(<var>fx<\/var>))<\/span>’, in which the outer function <span class=\"mathmode\"><var>F<\/var><\/span> and the inner function <span class=\"mathmode\"><var>F<\/var><\/span> must have different meanings, since the inner one has the form <span class=\"mathmode\"><var>φ<\/var>(<var>fx<\/var>)<\/span> and the outer one has the form <span class=\"mathmode\"><var>ψ<\/var>(<var>φ<\/var>(<var>fx<\/var>))<\/span>. Only the letter ‘<span class=\"mathmode\"><var>F<\/var><\/span>’ is common to the two functions, but the letter by itself signifies nothing.",
            "This immediately becomes clear if instead of ‘<span class=\"mathmode\"><var>F<\/var>(<var>Fu<\/var>)<\/span>’ we write ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>φ<\/var>):<\/span><var>F<\/var>(<var>φu<\/var>)<span class=\"mathrel\">.<\/span><var>φu<\/var><span class=\"mathrel\">=<\/span><var>Fu<\/var><\/span>’.",
    ...
    "3.341": {
        ...
        "PearsMcGuinness": [
            "So what is essential in a proposition is what all propositions that can express the same sense have in common.",
    ...
    "3.3411": {
        ...
        "PearsMcGuinness": [
            "So one could say that the real name of an object was what all symbols that signified it had in common. Thus, one by one, all kinds of composition would prove to be unessential to a name."
        ]
    },
    "3.342": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Although there is something arbitrary in our notations, <em>this much<\/em> is not arbitrary—that <em>when<\/em> we have determined one thing arbitrarily, something else is necessarily the case. (This derives from the <em>essence<\/em> of notation.)"
        ]
    },
    "3.3421": {
        "German": [
    ...
    "3.343": {
        ...
        "PearsMcGuinness": [
            "Definitions are rules for translating from one language into another. Any correct sign-language must be translatable into any other in accordance with such rules: it is <em>this<\/em> that they all have in common."
        ]
    },
    "3.344": {
        "German": [
        ...
        "PearsMcGuinness": [
            "What signifies in a symbol is what is common to all the symbols that the rules of logical syntax allow us to substitute for it."
        ]
    },
    "3.3441": {
        "German": [
        ...
        "PearsMcGuinness": [
            "For instance, we can express what is common to all notations for truth-functions in the following way: they have in common that, for example, the notation that uses ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ (‘not <span class=\"mathmode\"><var>p<\/var><\/span>’) and ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><var>q<\/var><\/span>’ (‘<span class=\"mathmode\"><var>p<\/var><\/span> or <span class=\"mathmode\"><var>q<\/var><\/span>’) <em>can be substituted<\/em> for any of them.",
    ...
    "3.3442": {
        ...
        "PearsMcGuinness": [
            "Nor does analysis resolve the sign for a complex in an arbitrary way, so that it would have a different resolution every time that it was incorporated in a different proposition."
        ]
    },
    "3.4": {
        "German": [
        ...
        "PearsMcGuinness": [
            "A proposition determines a place in logical space. The existence of this logical place is guaranteed by the mere existence of the constituents—by the existence of the proposition with a sense."
        ]
    },
    "3.41": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The propositional sign with logical co-ordinates—that is the logical place."
        ]
    },
    "3.411": {
        "German": [
    ...
    "3.42": {
        ...
        "PearsMcGuinness": [
            "A proposition can determine only one place in logical space: nevertheless the whole of logical space must already be given by it.",
    ...
    "4.003": {
        ...
        "PearsMcGuinness": [
            ...
            "And it is not surprising that the deepest problems are in fact <em>not<\/em> problems at all."
        ]
    },
    "4.0031": {
        "German": [
            "Alle Philosophie ist „Sprachkritik“. (Allerdings nicht im Sinne Mauthners.) Russells Verdienst ist es, gezeigt zu haben, dass die scheinbare logische Form des Satzes nicht seine wirkliche sein muss."
        ],
        "Ogden": [
    ...
    "4.012": {
        ...
        "PearsMcGuinness": [
            "It is obvious that a proposition of the form ‘<span class=\"mathmode\"><var>aRb<\/var><\/span>’ strikes us as a picture. In this case the sign is obviously a likeness of what is signified."
        ]
    },
    "4.013": {
        "German": [
        ...
        "PearsMcGuinness": [
            "And if we penetrate to the essence of this pictorial character, we see that it is <em>not<\/em> impaired by <em>apparent irregularities<\/em> (such as the use of <span class=\"mathmode\"><span class=\"symbol\">♯<\/span><\/span> and <span class=\"mathmode\"><span class=\"symbol\">♭<\/span><\/span> in musical notation).",
    ...
    "4.016": {
        ...
        "PearsMcGuinness": [
            "In order to understand the essential nature of a proposition, we should consider hieroglyphic script, which depicts the facts that it describes.",
    ...
    "4.021": {
        ...
        "PearsMcGuinness": [
            "A proposition is a picture of reality: for if I understand a proposition, I know the situation that it represents. And I understand the proposition without having had its sense explained to me."
        ]
    },
    "4.022": {
        "German": [
        ...
        "PearsMcGuinness": [
            "A proposition <em>shows<\/em> its sense.",
            "A proposition <em>shows<\/em> how things stand <em>if<\/em> it is true. And it <em>says that<\/em> they do so stand."
        ]
    },
    "4.023": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "A proposition constructs a world with the help of a logical scaffolding, so that one can actually see from the proposition how everything stands logically <em>if<\/em> it is true. One can <em>draw inferences<\/em> from a false proposition."
        ]
    },
    "4.024": {
        "German": [
    ...
    "4.025": {
        ...
        "PearsMcGuinness": [
            "When translating one language into another, we do not proceed by translating each <em>proposition<\/em> of the one into a <em>proposition<\/em> of the other, but merely by translating the constituents of propositions.",
    ...
    "4.026": {
        ...
        "PearsMcGuinness": [
            "The meanings of simple signs (words) must be explained to us if we are to understand them.",
    ...
    "4.027": {
        ...
        "PearsMcGuinness": [
            "It belongs to the essence of a proposition that it should be able to communicate a <em>new<\/em> sense to us."
        ]
    },
    "4.03": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "A proposition communicates a situation to us, and so it must be <em>essentially<\/em> connected with the situation.",
    ...
    "4.0311": {
        ...
        "PearsMcGuinness": [
            "One name stands for one thing, another for another thing, and they are combined with one another. In this way the whole group—like a <em>tableau vivant<\/em>—presents a state of affairs."
        ]
    },
    "4.0312": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "My fundamental idea is that the ‘logical constants’ are not representatives; that there can be no representatives of the <em>logic<\/em> of facts."
        ]
    },
    "4.032": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "(Even the proposition, <em>Ambulo<\/em>, is composite: for its stem with a different ending yields a different sense, and so does its ending with a different stem.)"
        ]
    },
    "4.04": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "The two must possess the same logical (mathematical) multiplicity. (Compare Hertz’s <em>Mechanics<\/em> on dynamical models.)"
        ]
    },
    "4.041": {
        "German": [
    ...
    "4.0411": {
        ...
        "PearsMcGuinness": [
            ...
            "If we were to try to do it by introducing a mark into the argument-places—for instance by writing ‘<span class=\"mathmode\"><span class=\"mathop\">(<var>G<\/var>, <var>G<\/var>).<\/span> <var>F<\/var>(<var>G<\/var>, <var>G<\/var>)<\/span>’—it would not be adequate: we should not be able to establish the identity of the variables. And so on.",
    ...
    "4.061": {
        "German": [
            ...
            "Man könnte dann z. B. sagen, dass „<span class=\"mathmode\"><var>p<\/var><\/span>“ auf die wahre Art bezeichnet, was „<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>“ auf die falsche Art, etc."
        ],
        "Ogden": [
        ...
        "PearsMcGuinness": [
            ...
            "In that case one could say, for example, that ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ signified in the true way what ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ signified in the false way, etc."
        ]
    },
    "4.062": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Can we not make ourselves understood with false propositions just as we have done up till now with true ones?—So long as it is known that they are meant to be false.—No! For a proposition is true if we use it to say that things stand in a certain way, and they do; and if by ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ we mean <span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span> and things stand as we mean that they do, then, construed in the new way, ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ is true and not false."
        ]
    },
    "4.0621": {
        "German": [
        ...
        "PearsMcGuinness": [
            "But it is important that the signs ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ and ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ can say the same thing. For it shows that nothing in reality corresponds to the sign ‘~’.",
            "The occurrence of negation in a proposition is not enough to characterize its sense (<span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><span class=\"mathrel\">=<\/span><var>p<\/var><\/span>).",
            "The propositions ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ and ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ have opposite sense, but there corresponds to them one and the same reality."
        ]
    },
    "4.063": {
        "German": [
    ...
    "4.064": {
        ...
        "PearsMcGuinness": [
            "Every proposition must <em>already<\/em> have a sense: it cannot be given a sense by affirmation. Indeed its sense is just what is affirmed. And the same applies to negation, etc."
        ]
    },
    "4.0641": {
        "German": [
        ...
        "PearsMcGuinness": [
            "One could say that negation must be related to the logical place determined by the negated proposition.",
            "The negating proposition determines a logical place <em>different<\/em> from that of the negated proposition.",
    ...
    "4.121": {
        ...
        "PearsMcGuinness": [
            ...
            "What expresses <em>itself<\/em> in language, <em>we<\/em> cannot express by means of language.",
            "Propositions <em>show<\/em> the logical form of reality.",
            "They display it."
        ]
    },
    "4.1211": {
        ...
        "PearsMcGuinness": [
            "Thus one proposition ‘<span class=\"mathmode\"><var>fa<\/var><\/span>’ shows that the object <span class=\"mathmode\"><var>a<\/var><\/span> occurs in its sense, two propositions ‘<span class=\"mathmode\"><var>fa<\/var><\/span>’ and ‘<span class=\"mathmode\"><var>ga<\/var><\/span>’ show that the same object is mentioned in both of them.",
    ...
    "4.123": {
        ...
        "PearsMcGuinness": [
            ...
            "(This shade of blue and that one stand, <em>eo ipso<\/em>, in the internal relation of lighter to darker. It is unthinkable that <em>these<\/em> two objects should not stand in this relation.)",
    ...
    "4.124": {
        ...
        "PearsMcGuinness": [
            "The existence of an internal property of a possible situation is not expressed by means of a proposition: rather, it expresses itself in the proposition representing the situation, by means of an internal property of that proposition.",
    ...
    "4.1241": {
        ...
        "PearsMcGuinness": [
            "It is impossible to distinguish forms from one another by saying that one has this property and another that property: for this presupposes that it makes sense to ascribe either property to either form."
        ]
    },
    "4.125": {
        "German": [
    ...
    "4.1251": {
        ...
        "PearsMcGuinness": [
            "Here we have the answer to the vexed question ‘whether all relations are internal or external’."
        ]
    },
    "4.1252": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "The same is true of the series of propositions ‘<span class=\"mathmode\"><var>aRb<\/var><\/span>’,",
            "‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>):<\/span><var>aRx<\/var><span class=\"mathrel\">.<\/span><var>xRb<\/var><\/span>’,",
            "‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>):<\/span><var>aRx<\/var><span class=\"mathrel\">.<\/span><var>xRy<\/var><span class=\"mathrel\">.<\/span><var>yRb<\/var><\/span>’, and so forth.",
            "(If <span class=\"mathmode\"><var>b<\/var><\/span> stands in one of these relations to <span class=\"mathmode\"><var>a<\/var><\/span>, I call <span class=\"mathmode\"><var>b<\/var><\/span> a successor of <span class=\"mathmode\"><var>a<\/var><\/span>.)"
        ]
    },
    "4.126": {
        ...
        "PearsMcGuinness": [
            "We can now talk about formal concepts, in the same sense that we speak of formal properties.",
    ...
    "4.127": {
        ...
        "PearsMcGuinness": [
            "The propositional variable signifies the formal concept, and its values signify the objects that fall under the concept."
        ]
    },
    "4.1271": {
        "German": [
    ...
    "4.1272": {
        ...
        "PearsMcGuinness": [
            "Thus the variable name ‘<span class=\"mathmode\"><var>x<\/var><\/span>’ is the proper sign for the pseudo-concept <em>object<\/em>.",
            "Wherever the word ‘object’ (‘thing’, etc.) is correctly used, it is expressed in conceptual notation by a variable name.",
            "For example, in the proposition, ‘There are 2 objects which …’, it is expressed by ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>)<\/span><span class=\"mathrel\">…<\/span><\/span>’.",
            "Wherever it is used in a different way, that is as a proper concept-word, nonsensical pseudo-propositions are the result.",
            "So one cannot say, for example, ‘There are objects’, as one might say, ‘There are books’. And it is just as impossible to say, ‘There are 100 objects’, or, ‘There are <span class=\"mathmode\"><span class=\"symbol\">ℵ<\/span><sub>0<\/sub><\/span> objects’.",
            "And it is nonsensical to speak of the <em>total number of objects<\/em>.",
            ...
            "(It is just as nonsensical to say, ‘There is only one 1’, as it would be to say, ‘<span class=\"mathmode\">2<span class=\"mathrel\">+<\/span>2<\/span> at 3 o’clock equals 4’.)"
        ]
    },
    "4.12721": {
        "German": [
    ...
    "4.1273": {
        ...
        "PearsMcGuinness": [
            "If we want to express in conceptual notation the general proposition, ‘<span class=\"mathmode\"><var>b<\/var><\/span> is a successor of <span class=\"mathmode\"><var>a<\/var><\/span>’, then we require an expression for the general term of the series of forms",
            "<div class=\"centered\"><span class=\"mathmode\"><var>aRb<\/var><\/span>,<br \/>\n<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>):<\/span><var>aRx<\/var><span class=\"mathrel\">.<\/span><var>xRb<\/var><\/span>,<br \/>\n<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>):<\/span><var>aRx<\/var><span class=\"mathrel\">.<\/span><var>xRy<\/var><span class=\"mathrel\">.<\/span><var>yRb<\/var><\/span>,<br \/>\n…&nbsp; .<\/div>",
    ...
    "4.1274": {
        ...
        "PearsMcGuinness": [
            "To ask whether a formal concept exists is nonsensical. For no proposition can be the answer to such a question.",
    ...
    "4.128": {
        ...
        "PearsMcGuinness": [
            "Logical forms are <em>without<\/em> number.",
    ...
    "4.23": {
        ...
        "PearsMcGuinness": [
            "It is only in the nexus of an elementary proposition that a name occurs in a proposition."
        ]
    },
    "4.24": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Names are the simple symbols: I indicate them by single letters (‘<span class=\"mathmode\"><var>x<\/var><\/span>’, ‘<span class=\"mathmode\"><var>y<\/var><\/span>’, ‘<span class=\"mathmode\"><var>z<\/var><\/span>’).",
            "I write elementary propositions as functions of names, so that they have the form ‘<span class=\"mathmode\"><var>fx<\/var><\/span>’, ‘<span class=\"mathmode\"><var>φ<\/var>(<var>x<\/var>,<var>y<\/var>)<\/span>’, etc.",
            "Or I indicate them by the letters ‘<span class=\"mathmode\"><var>p<\/var><\/span>’, ‘<span class=\"mathmode\"><var>q<\/var><\/span>’, ‘<span class=\"mathmode\"><var>r<\/var><\/span>’."
        ]
    },
    "4.241": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "So ‘<span class=\"mathmode\"><var>a<\/var><span class=\"mathrel\">=<\/span><var>b<\/var><\/span>’ means that the sign ‘<span class=\"mathmode\"><var>b<\/var><\/span>’ can be substituted for the sign ‘<span class=\"mathmode\"><var>a<\/var><\/span>’.",
            "(If I use an equation to introduce a new sign ‘<span class=\"mathmode\"><var>b<\/var><\/span>’, laying down that it shall serve as a substitute for a sign ‘<span class=\"mathmode\"><var>a<\/var><\/span>’ that is already known, then, like Russell, I write the equation—definition—in the form ‘<span class=\"mathmode\"><var>a<\/var><span class=\"mathrel\">=<\/span><var>b<\/var><\/span> Def.’ A definition is a rule dealing with signs.)"
        ]
    },
    "4.242": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Expressions of the form ‘<span class=\"mathmode\"><var>a<\/var><span class=\"mathrel\">=<\/span><var>b<\/var><\/span>’ are, therefore, mere representational devices. They state nothing about the meaning of the signs ‘<span class=\"mathmode\"><var>a<\/var><\/span>’ and ‘<span class=\"mathmode\"><var>b<\/var><\/span>’."
        ]
    },
    "4.243": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Can we understand two names without knowing whether they signify the same thing or two different things?—Can we understand a proposition in which two names occur without knowing whether their meaning is the same or different?",
            ...
            "Expressions like ‘<span class=\"mathmode\"><var>a<\/var><span class=\"mathrel\">=<\/span><var>a<\/var><\/span>’, and those derived from them, are neither elementary propositions nor is there any other way in which they have sense. (This will become evident later.)"
        ]
    },
    "4.25": {
        "German": [
    ...
    "4.27": {
        ...
        "PearsMcGuinness": [
            "For <span class=\"mathmode\"><var>n<\/var><\/span> states of affairs, there are <table class=\"possibilities\"><tr><td rowspan=\"3\" class=\"middleright\"><span class=\"mathmode\">K<sub><var>n<\/var><\/sub> = <\/span><\/td><td class=\"summationtop\"><span class=\"mathmode\"><var class=\"smallvar\">n<\/var><\/span><\/td><td rowspan=\"3\" class=\"middleright\"><span class=\"largeparen\">(<\/span><\/td><td rowspan=\"3\" class=\"middlecenter\"><span class=\"mathmode\"><var>n<\/var><\/span><br \/><span class=\"mathmode\"><var>ν<\/var><\/span><\/td><td rowspan=\"3\" class=\"middleleft\"><span class=\"largeparen\">)<\/span><\/td><\/tr><tr><td class=\"summationmiddle\"><span class=\"mathmode\"><span class=\"largeop\">∑<\/span><\/span><\/td><\/tr><tr><td class=\"summationbottom\"><span class=\"mathmode\"><span class=\"smallvar\"><var>ν<\/var> = 0<\/span><\/span><\/td><\/tr><\/table> possibilities of existence and non-existence.",
    ...
    "4.28": {
        ...
        "PearsMcGuinness": [
            "There correspond to these combinations the same number of possibilities of truth—and falsity—for <span class=\"mathmode\"><var>n<\/var><\/span> elementary propositions."
        ]
    },
    "4.3": {
        "German": [
    ...
    "4.4": {
        ...
        "PearsMcGuinness": [
            "A proposition is an expression of agreement and disagreement with truth-possibilities of elementary propositions."
        ]
    },
    "4.41": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Truth-possibilities of elementary propositions are the conditions of the truth and falsity of propositions."
        ]
    },
    "4.411": {
        "German": [
        ...
        "PearsMcGuinness": [
            "It immediately strikes one as probable that the introduction of elementary propositions provides the basis for understanding all other kinds of proposition. Indeed the understanding of general propositions <em>palpably<\/em> depends on the understanding of elementary propositions."
        ]
    },
    "4.42": {
        "German": [
        ...
        "PearsMcGuinness": [
            "For <span class=\"mathmode\"><var>n<\/var><\/span> elementary propositions there are <table class=\"possibilities\"><tr><td class=\"summationtop\"><span class=\"mathmode\"><span class=\"smallvar\">K<sub><var>n<\/var><\/sub><\/span><\/span><\/td><td class=\"middleright\" rowspan=\"3\"><span class=\"largeparen\">(<\/span><\/td><td class=\"middlecenter\" rowspan=\"3\"><span class=\"mathode\">K<sub><var>n<\/var><\/sub><\/span><br \/><span class=\"mathmode\"><var>κ<\/var><\/span><\/td><td class=\"middleright\" rowspan=\"3\"><span class=\"mathomde\"><span class=\"largeparen\">)<\/span> = L<sub><var>n<\/var><\/sub><\/span><\/td><\/tr><tr><td class=\"summationmiddle\"><span class=\"mathmode\"><span class=\"largeop\">∑<\/span><\/span><\/td><\/tr><tr><td class=\"summationmiddle\"><span class=\"mathmode\"><span class=\"smallvar\"><var>κ<\/var> = 0<\/span><\/span><\/td><\/tr><\/table>  ways in which a proposition can agree and disagree with their truth possibilities."
        ]
    },
    "4.43": {
        "German": [
    ...
    "4.431": {
        ...
        "PearsMcGuinness": [
            ...
            "(Thus Frege was quite right to use them as a starting point when he explained the signs of his conceptual notation. But the explanation of the concept of truth that Frege gives is mistaken: if ‘the true’ and ‘the false’ were really objects, and were the arguments in <span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span> etc., then Frege’s method of determining the sense of ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ would leave it absolutely undetermined.)"
        ]
    },
    "4.44": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The sign that results from correlating the mark ‘T’ with truth-possibilities is a propositional sign."
        ]
    },
    "4.441": {
        "German": [
        ...
        "PearsMcGuinness": [
            "It is clear that a complex of the signs ‘F’ and ‘T’ has no object (or complex of objects) corresponding to it, just as there is none corresponding to the horizontal and vertical lines or to the brackets.—There are no ‘logical objects’.",
    ...
    "4.46": {
        ...
        "PearsMcGuinness": [
            "Among the possible groups of truth-conditions there are two extreme cases.",
            "In one of these cases the proposition is true for all the truth-possibilities of the elementary propositions. We say that the truth-conditions are <em>tautological<\/em>.",
            "In the second case the proposition is false for all the truth-possibilities: the truth-conditions are <em>contradictory<\/em>.",
    ...
    "4.462": {
        ...
        "PearsMcGuinness": [
            "Tautologies and contradictions are not pictures of reality. They do not represent any possible situations. For the former admit <em>all<\/em> possible situations, and latter <em>none<\/em>.",
    ...
    "4.465": {
        ...
        "PearsMcGuinness": [
            "The logical product of a tautology and a proposition says the same thing as the proposition. This product, therefore, is identical with the proposition. For it is impossible to alter what is essential to a symbol without altering its sense."
        ]
    },
    "4.466": {
        "German": [
        ...
        "PearsMcGuinness": [
            "What corresponds to a determinate logical combination of signs is a determinate logical combination of their meanings. It is only to the uncombined signs that <em>absolutely any<\/em> combination corresponds.",
            ...
            "(And what is not a logical combination has <em>no<\/em> combination of objects corresponding to it.)",
    ...
    "4.4661": {
        ...
        "PearsMcGuinness": [
            "Admittedly the signs are still combined with one another even in tautologies and contradictions—i.e. they stand in certain relations to one another: but these relations have no meaning, they are not essential to the <em>symbol<\/em>."
        ]
    },
    "4.5": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "It is clear that <em>only<\/em> what is essential to the most general propositional form may be included in its description—for otherwise it would not be the most general form.",
    ...
    "4.51": {
        ...
        "PearsMcGuinness": [
            "Suppose that I am given <em>all<\/em> elementary propositions: then I can simply ask what propositions I can construct out of them. And there I have <em>all<\/em> propositions, and <em>that<\/em> fixes their limits."
        ]
    },
    "4.52": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Propositions comprise all that follows from the totality of all elementary propositions (and, of course, from its being the <em>totality<\/em> of them <em>all<\/em>). (Thus, in a certain sense, it could be said that <em>all<\/em> propositions were generalizations of elementary propositions.)"
        ]
    },
    "4.53": {
        "German": [
    ...
    "5.101": {
        ...
        "PearsMcGuinness": [
            ...
            "<!-- noindent --><table class=\"fnlist\"> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >Tautology&nbsp;<\/td><td >(If <span class=\"mathmode\"><var>p<\/var><\/span> then <span class=\"mathmode\"><var>p<\/var><\/span>; and if <span class=\"mathmode\"><var>q<\/var><\/span> then <span class=\"mathmode\"><var>q<\/var><\/span>.) &nbsp;&nbsp; <span class=\"mathmode\">(<var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>p<\/var><span class=\"mathrel\">.<\/span><var>q<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>q<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >In&nbsp;words:&nbsp;<\/td><td >Not both <span class=\"mathmode\"><var>p<\/var><\/span> and <span class=\"mathmode\"><var>q<\/var><\/span>. &nbsp;&nbsp; <span class=\"mathmode\">(<span class=\"mathop\">~<\/span>(<var>p<\/var><span class=\"mathrel\">.<\/span><var>q<\/var>))<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td >If <span class=\"mathmode\"><var>q<\/var><\/span> then <span class=\"mathmode\"><var>p<\/var><\/span>. &nbsp;&nbsp; <span class=\"mathmode\">(<var>q<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>p<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td >If <span class=\"mathmode\"><var>p<\/var><\/span> then <span class=\"mathmode\"><var>q<\/var><\/span>. &nbsp;&nbsp; <span class=\"mathmode\">(<var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>q<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td ><span class=\"mathmode\"><var>p<\/var><\/span> or <span class=\"mathmode\"><var>q<\/var><\/span>. &nbsp;&nbsp; <span class=\"mathmode\">(<var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><var>q<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td >Not <span class=\"mathmode\"><var>q<\/var><\/span>.  &nbsp;&nbsp; <span class=\"mathmode\">(<span class=\"mathop\">~<\/span><var>q<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td >Not <span class=\"mathmode\"><var>p<\/var><\/span>.  &nbsp;&nbsp; <span class=\"mathmode\">(<span class=\"mathop\">~<\/span><var>p<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td ><span class=\"mathmode\"><var>p<\/var><\/span> or <span class=\"mathmode\"><var>q<\/var><\/span>, but not both.  &nbsp;&nbsp; <span class=\"mathmode\">(<var>p<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>q<\/var><span class=\"mathrel\">:<span class=\"symbol\">∨<\/span>:<\/span><var>q<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>p<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td >If <span class=\"mathmode\"><var>p<\/var><\/span> then <span class=\"mathmode\"><var>q<\/var><\/span>, and if <span class=\"mathmode\"><var>q<\/var><\/span> then <span class=\"mathmode\"><var>p<\/var><\/span>.  &nbsp;&nbsp; <span class=\"mathmode\">(<var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">≡<\/span><\/span><var>q<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td ><span class=\"mathmode\"><var>p<\/var><\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td ><span class=\"mathmode\"><var>q<\/var><\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td >Neither <span class=\"mathmode\"><var>p<\/var><\/span> nor <span class=\"mathmode\"><var>q<\/var><\/span>.  &nbsp;&nbsp; <span class=\"mathmode\">(<span class=\"mathop\">~<\/span><var>p<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>q<\/var><\/span> or <span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\">|<\/span><var>q<\/var>)<\/span><\/td><\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td ><span class=\"mathmode\"><var>p<\/var><\/span> and not <span class=\"mathmode\"><var>q<\/var><\/span>.  &nbsp;&nbsp; <span class=\"mathmode\">(<var>p<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>q<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td ><span class=\"mathmode\"><var>q<\/var><\/span> and not <span class=\"mathmode\"><var>p<\/var><\/span>.  &nbsp;&nbsp; <span class=\"mathmode\">(<var>q<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>p<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >T<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\" >&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:<\/td><td ><span class=\"mathmode\"><var>q<\/var><\/span> and <span class=\"mathmode\"><var>p<\/var><\/span>.  &nbsp;&nbsp; <span class=\"mathmode\">(<var>q<\/var><span class=\"mathrel\">.<\/span><var>p<\/var>)<\/span><\/td> <\/tr> <tr><td class=\"righttight\" >(<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"centertight\" >F<\/td><td class=\"lefttight\" >)<\/td><td class=\"leftcell\" ><span class=\"mathmode\">(<var>p<\/var>,&nbsp;<var>q<\/var>)<\/span>&nbsp;&nbsp;<\/td><td class=\"leftcell\"  colspan=\"2\">Contradiction (<span class=\"mathmode\"><var>p<\/var><\/span> and not <span class=\"mathmode\"><var>p<\/var><\/span>, and <span class=\"mathmode\"><var>q<\/var><\/span> and not <span class=\"mathmode\"><var>q<\/var><\/span>.)  &nbsp;&nbsp; <span class=\"mathmode\">(<var>p<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>p<\/var><span class=\"mathrel\">.<\/span><var>q<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>q<\/var>)<\/span><\/td><\/tr><\/table>",
            "I will give the name <em>truth-grounds<\/em> of a proposition to those truth-possibilities of its truth-arguments that make it true."
        ]
    },
    "5.11": {
        "German": [
    ...
    "5.12": {
        ...
        "PearsMcGuinness": [
            "In particular, the truth of a proposition ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ follows from the truth of another proposition ‘<span class=\"mathmode\"><var>q<\/var><\/span>’ if all the truth-grounds of the latter are truth-grounds of the former."
        ]
    },
    "5.121": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The truth-grounds of the one are contained in those of the other: <span class=\"mathmode\"><var>p<\/var><\/span> follows from <span class=\"mathmode\"><var>q<\/var><\/span>."
        ]
    },
    "5.122": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If <span class=\"mathmode\"><var>p<\/var><\/span> follows from <span class=\"mathmode\"><var>q<\/var><\/span>, the sense of ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ is contained in the sense of ‘<span class=\"mathmode\"><var>q<\/var><\/span>’."
        ]
    },
    "5.123": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If a god creates a world in which certain propositions are true, then by that very act he also creates a world in which all the propositions that follow from them come true. And similarly he could not create a world in which the proposition ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ was true without creating all its objects."
        ]
    },
    "5.124": {
        "German": [
    ...
    "5.1241": {
        ...
        "PearsMcGuinness": [
            "‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\">.<\/span><var>q<\/var><\/span>’ is one of the propositions that affirm ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ and at the same time one of the propositions that affirm ‘<span class=\"mathmode\"><var>q<\/var><\/span>’.",
    ...
    "5.1311": {
        ...
        "PearsMcGuinness": [
            "When we infer <span class=\"mathmode\"><var>q<\/var><\/span> from <span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><var>q<\/var><\/span> and <span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>, the relation between the propositional forms of ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><var>q<\/var><\/span>’ and ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ is masked, in this case, by our mode of signifying. But if instead of ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><var>q<\/var><\/span>’ we write, for example, ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\">|<\/span><var>q<\/var><span class=\"mathrel\">.|.<\/span><var>p<\/var><span class=\"mathrel\">|<\/span><var>q<\/var><\/span>’, and instead of ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’, ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\">|<\/span><var>p<\/var><\/span>’ (<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\">|<\/span><var>q<\/var><\/span> = neither <span class=\"mathmode\"><var>p<\/var><\/span> nor <span class=\"mathmode\"><var>q<\/var><\/span>), then the inner connexion becomes obvious.",
            "(The possibility of inference from <span class=\"mathmode\"><span class=\"quant\">(<var>x<\/var>).<\/span><var>fx<\/var><\/span> to <span class=\"mathmode\"><var>fa<\/var><\/span> shows that the symbol <span class=\"mathmode\"><span class=\"quant\">(<var>x<\/var>).<\/span><var>fx<\/var><\/span> itself has generality in it.)"
        ]
    },
    "5.132": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If <span class=\"mathmode\"><var>p<\/var><\/span> follows from <span class=\"mathmode\"><var>q<\/var><\/span>, I can make an inference from <span class=\"mathmode\"><var>q<\/var><\/span> to <span class=\"mathmode\"><var>p<\/var><\/span>, deduce <span class=\"mathmode\"><var>p<\/var><\/span> from <span class=\"mathmode\"><var>q<\/var><\/span>.",
    ...
    "5.133": {
        ...
        "PearsMcGuinness": [
            "All deductions are made <em>a priori<\/em>."
        ]
    },
    "5.134": {
        "German": [
    ...
    "5.1361": {
        ...
        "PearsMcGuinness": [
            "We <em>cannot<\/em> infer the events of the future from those of the present.",
    ...
    "5.1362": {
        ...
        "PearsMcGuinness": [
            "The freedom of the will consists in the impossibility of knowing actions that still lie in the future. We could know them only if causality were an <em>inner<\/em> necessity like that of logical inference.—The connexion between knowledge and what is known is that of logical necessity.",
            "(‘A knows that <span class=\"mathmode\"><var>p<\/var><\/span> is the case’, has no sense if <span class=\"mathmode\"><var>p<\/var><\/span> is a tautology.)"
        ]
    },
    "5.1363": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If the truth of a proposition does not <em>follow<\/em> from the fact that it is self-evident to us, then its self-evidence in no way justifies our belief in its truth."
        ]
    },
    "5.14": {
        "German": [
    ...
    "5.143": {
        ...
        "PearsMcGuinness": [
            "Contradiction is that common factor of propositions which <em>no<\/em> proposition has in common with another. Tautology is the common factor of all propositions that have nothing in common with one another.",
    ...
    "5.15": {
        ...
        "PearsMcGuinness": [
            "If <span class=\"mathmode\"><span class=\"mathrm\">T<\/span><sub><var>r<\/var><\/sub><\/span> is the number of the truth-grounds of a proposition ‘<span class=\"mathmode\"><var>r<\/var><\/span>’, and if <span class=\"mathmode\"><span class=\"mathrm\">T<\/span><sub><var>rs<\/var><\/sub><\/span> is the number of the truth-grounds of a proposition ‘<span class=\"mathmode\"><var>s<\/var><\/span>’ that are at the same time truth-grounds of ‘<span class=\"mathmode\"><var>r<\/var><\/span>’, then we call the ratio <span class=\"mathmode\"><span class=\"mathrm\">T<\/span><sub><var>rs<\/var><\/sub> : <span class=\"mathrm\">T<\/span><sub><var>r<\/var><\/sub><\/span> the degree of probability that the proposition ‘<span class=\"mathmode\"><var>r<\/var><\/span>’ gives to the proposition ‘<span class=\"mathmode\"><var>s<\/var><\/span>’."
        ]
    },
    "5.151": {
        "German": [
        ...
        "PearsMcGuinness": [
            "In a schema like the one above in 5.101, let <span class=\"mathmode\"><span class=\"mathrm\">T<\/span><sub><var>r<\/var><\/sub><\/span> be the number of ‘T’s’ in the proposition <span class=\"mathmode\"><var>r<\/var><\/span>, and let <span class=\"mathmode\"><span class=\"mathrm\">T<\/span><sub><var>rs<\/var><\/sub><\/span>, be the number of ‘T’s’ in the proposition <span class=\"mathmode\"><var>s<\/var><\/span> that stand in columns in which the proposition <span class=\"mathmode\"><var>r<\/var><\/span> has ‘T’s’. Then the proposition <span class=\"mathmode\"><var>r<\/var><\/span> gives to the proposition <span class=\"mathmode\"><var>s<\/var><\/span> the probability <span class=\"mathmode\"><span class=\"mathrm\">T<\/span><sub><var>rs<\/var><\/sub> : <span class=\"mathrm\">T<\/span><sub><var>r<\/var><\/sub><\/span>."
        ]
    },
    "5.1511": {
        "German": [
    ...
    "5.152": {
        ...
        "PearsMcGuinness": [
            "When propositions have no truth-arguments in common with one another, we call them independent of one another.",
            "Two elementary propositions give one another the probability <span class=\"mathmode\">½<\/span>.",
            "If <span class=\"mathmode\"><var>p<\/var><\/span> follows from <span class=\"mathmode\"><var>q<\/var><\/span>, then the proposition ‘<span class=\"mathmode\"><var>q<\/var><\/span>’ gives to the proposition ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ the probability 1. The certainty of logical inference is a limiting case of probability.",
    ...
    "5.153": {
        ...
        "PearsMcGuinness": [
            "In itself, a proposition is neither probable nor improbable. Either an event occurs or it does not: there is no middle way."
        ]
    },
    "5.154": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "So <em>this<\/em> is not a mathematical truth.",
            "Now, if I say, ‘The probability of my drawing a white ball is equal to the probability of my drawing a black one’, this means that all the circumstances that I know of (including the laws of nature assumed as hypotheses) give no <em>more<\/em> probability to the occurrence of the one event than to that of the other. That is to say, they give each the probability <span class=\"mathmode\">½<\/span>, as can easily be gathered from the above definitions.",
    ...
    "5.155": {
        ...
        "PearsMcGuinness": [
            "The minimal unit for a probability proposition is this: The circumstances—of which I have no further knowledge—give such and such a degree of probability to the occurrence of a particular event."
        ]
    },
    "5.156": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "It involves a general description of a propositional form.",
            "We use probability only in default of certainty—if our knowledge of a fact is not indeed complete, but we do know <em>something<\/em> about its form.",
            "(A proposition may well be an incomplete picture of a certain situation, but it is always a complete picture of <em>something<\/em>.)",
    ...
    "5.21": {
        ...
        "PearsMcGuinness": [
            "In order to give prominence to these internal relations we can adopt the following mode of expression: we can represent a proposition as the result of an operation that produces it out of other propositions (which are the bases of the operation)."
        ]
    },
    "5.22": {
        "German": [
    ...
    "5.23": {
        ...
        "PearsMcGuinness": [
            "The operation is what has to be done to the one proposition in order to make the other out of it."
        ]
    },
    "5.231": {
        "German": [
        ...
        "PearsMcGuinness": [
            "And that will, of course, depend on their formal properties, on the internal similarity of their forms."
        ]
    },
    "5.232": {
        "German": [
    ...
    "5.24": {
        ...
        "PearsMcGuinness": [
            "An operation manifests itself in a variable; it shows how we can get from one form of proposition to another.",
            "It gives expression to the difference between the forms.",
    ...
    "5.242": {
        ...
        "PearsMcGuinness": [
            "The operation that produces ‘<span class=\"mathmode\"><var>q<\/var><\/span>’ from ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ also produces ‘<span class=\"mathmode\"><var>r<\/var><\/span>’ from ‘<span class=\"mathmode\"><var>q<\/var><\/span>’, and so on. There is only one way of expressing this: ‘<span class=\"mathmode\"><var>p<\/var><\/span>’, ‘<span class=\"mathmode\"><var>q<\/var><\/span>’, ‘<span class=\"mathmode\"><var>r<\/var><\/span>’, etc. have to be variables that give expression in a general way to certain formal relations."
        ]
    },
    "5.25": {
        "German": [
    ...
    "5.251": {
        ...
        "PearsMcGuinness": [
            "A function cannot be its own argument, whereas an operation can take one of its own results as its base."
        ]
    },
    "5.252": {
        "German": [
        ...
        "PearsMcGuinness": [
            "It is only in this way that the step from one term of a series of forms to another is possible (from one type to another in the hierarchies of Russell and Whitehead). (Russell and Whitehead did not admit the possibility of such steps, but repeatedly availed themselves of it.)"
        ]
    },
    "5.2521": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If an operation is applied repeatedly to its own results, I speak of successive applications of it. (‘<span class=\"mathmode\"><span class=\"mathop\"><span class=\"mathrm\">O<\/span>’<\/span><span class=\"mathop\"><span class=\"mathrm\">O<\/span>’<\/span><span class=\"mathop\"><span class=\"mathrm\">O<\/span>’<\/span><var>a<\/var><\/span>’ is the result of three successive applications of the operation ‘<span class=\"mathmode\"><span class=\"mathop\"><span class=\"mathrm\">O<\/span>’<\/span><var>ξ<\/var><\/span>’ to ‘<span class=\"mathmode\"><var>a<\/var><\/span>’.)",
            "In a similar sense I speak of successive applications of <em>more than one<\/em> operation to a number of propositions."
        ]
    },
    "5.2522": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Accordingly I use the sign ‘<span class=\"mathmode\">[<var>a<\/var>, <var>x<\/var>, <span class=\"mathop\"><span class=\"mathrm\">O<\/span>’<\/span><var>x<\/var>]<\/span>’ for the general term of the series of forms <span class=\"mathmode\"><var>a<\/var>, <span class=\"mathop\"><span class=\"mathrm\">O<\/span>’<\/span><var>a<\/var>, <span class=\"mathop\"><span class=\"mathrm\">O<\/span>’<\/span><span class=\"mathop\"><span class=\"mathrm\">O<\/span>’<\/span><var>a<\/var>,<span class=\"mathrel\">…<\/span><\/span>. This bracketed expression is a variable: the first term of the bracketed expression is the beginning of the series of forms, the second is the form of a term <span class=\"mathmode\"><var>x<\/var><\/span> arbitrarily selected from the series, and the third is the form of the term that immediately follows <span class=\"mathmode\"><var>x<\/var><\/span> in the series."
        ]
    },
    "5.2523": {
        "German": [
    ...
    "5.254": {
        ...
        "PearsMcGuinness": [
            "An operation can vanish (e.g. negation in ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’: <span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><span class=\"mathrel\">=<\/span><var>p<\/var><\/span>)."
        ]
    },
    "5.3": {
        "German": [
    ...
    "5.31": {
        ...
        "PearsMcGuinness": [
            "The schemata in 4.31 have a meaning even when ‘<span class=\"mathmode\"><var>p<\/var><\/span>’, ‘<span class=\"mathmode\"><var>q<\/var><\/span>’, ‘<span class=\"mathmode\"><var>r<\/var><\/span>’, etc. are not elementary propositions.",
            "And it is easy to see that the propositional sign in 4.442 expresses a single truth-function of elementary propositions even when ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ and ‘<span class=\"mathmode\"><var>q<\/var><\/span>’ are truth-functions of elementary propositions."
        ]
    },
    "5.32": {
        "German": [
        ...
        "PearsMcGuinness": [
            "All truth-functions are results of successive applications to elementary propositions of a finite number of truth-operations."
        ]
    },
    "5.4": {
        "German": [
        ...
        "PearsMcGuinness": [
            "At this point it becomes manifest that there are no ‘logical objects’ or ‘logical constants’ (in Frege’s and Russell’s sense)."
        ]
    },
    "5.41": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The reason is that the results of truth-operations on truth-functions are always identical whenever they are one and the same truth-function of elementary propositions."
        ]
    },
    "5.42": {
        "German": [
        ...
        "PearsMcGuinness": [
            "It is self-evident that ∨, ⊃, etc. are not relations in the sense in which right and left etc. are relations.",
    ...
    "5.43": {
        ...
        "PearsMcGuinness": [
            "Even at first sight it seems scarcely credible that there should follow from one fact <span class=\"mathmode\"><var>p<\/var><\/span> infinitely many <em>others<\/em>, namely <span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>, <span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>, etc. And it is no less remarkable that the infinite number of propositions of logic (mathematics) follow from half a dozen ‘primitive propositions’.",
    ...
    "5.44": {
        ...
        "PearsMcGuinness": [
            "Truth-functions are not material functions.",
            "For example, an affirmation can be produced by double negation: in such a case does it follow that in some sense negation is contained in affirmation? Does ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ negate <span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>, or does it affirm <span class=\"mathmode\"><var>p<\/var><\/span>—or both?",
            "The proposition ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ is not about negation, as if negation were an object: on the other hand, the possibility of negation is already written into affirmation.",
            "And if there were an object called ‘~’, it would follow that ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ said something different from what ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ said, just because the one proposition would then be about ~ and the other would not."
        ]
    },
    "5.441": {
        "German": [
    ...
    "5.442": {
        ...
        "PearsMcGuinness": [
            "If we are given a proposition, then <em>with it<\/em> we are also given the results of all truth-operations that have it as their base."
        ]
    },
    "5.45": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If there are primitive logical signs, then any logic that fails to show clearly how they are placed relatively to one another and to justify their existence will be incorrect. The construction of logic <em>out of<\/em> its primitive signs must be made clear."
        ]
    },
    "5.451": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "(In short, Frege’s remarks about introducing signs by means of definitions (in <em>The Fundamental Laws of Arithmetic<\/em>) also apply, <em>mutatis mutandis<\/em>, to the introduction of primitive signs.)"
        ]
    },
    "5.452": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The introduction of any new device into the symbolism of logic is necessarily a momentous event. In logic a new device should not be introduced in brackets or in a footnote with what one might call a completely innocent air.",
            "(Thus in Russell and Whitehead’s <em>Principia Mathematica<\/em> there occur definitions and primitive propositions expressed in words. Why this sudden appearance of words? It would require a justification, but none is given, or could be given, since the procedure is in fact illicit.)",
            "But if the introduction of a new device has proved necessary at a certain point, we must immediately ask ourselves, ‘At what points is the employment of this device now <em>unavoidable<\/em>?’ and its place in logic must be made clear."
        ]
    },
    "5.453": {
        "German": [
    ...
    "5.454": {
        ...
        "PearsMcGuinness": [
            "In logic there is no co-ordinate status, and there can be no classification.",
    ...
    "5.4541": {
        ...
        "PearsMcGuinness": [
            ...
            "Men have always had a presentiment that there must be a realm in which the answers to questions are symmetrically combined—<em>a priori<\/em>—to form a self-contained system.",
            "A realm subject to the law: <em>Simplex sigillum veri<\/em>."
        ]
    },
    "5.46": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If we introduced logical signs properly, then we should also have introduced at the same time the sense of all combinations of them; i.e. not only ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><var>q<\/var><\/span>’ but ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span>(<var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><span class=\"mathop\">~<\/span><var>q<\/var>)<\/span>’ as well, etc. etc. We should also have introduced at the same time the effect of all possible combinations of brackets. And thus it would have been made clear that the real general primitive signs are not ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><var>q<\/var><\/span>’, ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>fx<\/var><\/span>’, etc. but the most general form of their combinations."
        ]
    },
    "5.461": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Though it seems unimportant, it is in fact significant that the pseudo-relations of logic, such as ∨ and ⊃, need brackets—unlike real relations.",
    ...
    "5.47": {
        ...
        "PearsMcGuinness": [
            "It is clear that whatever we can say <em>in advance<\/em> about the form of all propositions, we must be able to say <em>all at once<\/em>.",
            "An elementary proposition really contains all logical operations in itself. For ‘<span class=\"mathmode\"><var>fa<\/var><\/span>’ says the same thing as",
            "<div class=\"centered\"><span class=\"mathmode\">‘<span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>fx<\/var><span class=\"mathrel\">.<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><var>a<\/var>’.<\/span><\/div><span class=\"mathmode\"><\/span>",
            ...
            "One could say that the sole logical constant was what <em>all<\/em> propositions, by their very nature, had in common with one another.",
    ...
    "5.4731": {
        ...
        "PearsMcGuinness": [
            "Self-evidence, which Russell talked about so much, can become dispensable in logic, only because language itself prevents every logical mistake.—What makes logic <em>a priori<\/em> is the <em>impossibility<\/em> of illogical thought."
        ]
    },
    "5.4732": {
        "German": [
    ...
    "5.47321": {
        ...
        "PearsMcGuinness": [
            "Occam’s maxim is, of course, not an arbitrary rule, nor one that is justified by its success in practice: its point is that <em>unnecessary<\/em> units in a sign-language mean nothing.",
            "Signs that serve <em>one<\/em> purpose are logically equivalent, and signs that serve <em>none<\/em> are logically meaningless."
        ]
    },
    "5.4733": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Frege says that any legitimately constructed proposition must have a sense. And I say that any possible proposition is legitimately constructed, and, if it has no sense, that can only be because we have failed to give a <em>meaning<\/em> to some of its constituents.",
    ...
    "5.474": {
        ...
        "PearsMcGuinness": [
            "The number of fundamental operations that are necessary depends <em>solely<\/em> on our notation."
        ]
    },
    "5.475": {
        "German": [
    ...
    "5.476": {
        ...
        "PearsMcGuinness": [
            "It is clear that this is not a question of a <em>number of primitive ideas<\/em> that have to be signified, but rather of the expression of a rule."
        ]
    },
    "5.5": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Every truth-function is a result of successive applications to elementary propositions of the operation ‘<span class=\"mathmode\"><span class=\"mathop\">(−−−−−<span class=\"mathrm\">T<\/span>)<\/span><\/span> <span class=\"mathmode\">(<var>ξ<\/var>,&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.)<\/span>’.",
    ...
    "5.501": {
        ...
        "PearsMcGuinness": [
            "When a bracketed expression has propositions as its terms—and the order of the terms inside the brackets is indifferent—then I indicate it by a sign of the form ‘<span class=\"mathmode\">(<span class=\"overlined\"><var>ξ<\/var><\/span>)<\/span>’. ‘<span class=\"mathmode\"><var>ξ<\/var><\/span>’ is a variable whose values are terms of the bracketed expression and the bar over the variable indicates that it is the representative of all its values in the brackets.",
            "(E.g. if <span class=\"mathmode\"><var>ξ<\/var><\/span> has the three values P, Q, R, then <span class=\"mathmode\">(<span class=\"overlined\"><var>ξ<\/var><\/span>)<span class=\"mathrel\">=<\/span>(<span class=\"mathrm\">P<\/span>, <span class=\"mathrm\">Q<\/span>, <span class=\"mathrm\">R<\/span>)<\/span>. )",
            ...
            "We <em>can<\/em> distinguish three kinds of description: 1. direct enumeration, in which case we can simply substitute for the variable the constants that are its values; 2. giving a function <span class=\"mathmode\"><var>fx<\/var><\/span> whose values for all values of <span class=\"mathmode\"><var>x<\/var><\/span> are the propositions to be described; 3. giving a formal law that governs the construction of the propositions, in which case the bracketed expression has as its members all the terms of a series of forms."
        ]
    },
    "5.502": {
        "German": [
        ...
        "PearsMcGuinness": [
            "So instead of ‘<span class=\"mathmode\"><span class=\"mathop\">(−−−−−<span class=\"mathrm\">T<\/span>)<\/span><\/span> <span class=\"mathmode\">(<var>ξ<\/var>,&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.)<\/span>’, I write ‘<span class=\"mathmode\"><span class=\"nop\">N<\/span>(<span class=\"overlined\"><var>ξ<\/var><\/span>)<\/span>’.",
            "<span class=\"mathmode\"><span class=\"nop\">N<\/span>(<span class=\"overlined\"><var>ξ<\/var><\/span>)<\/span> is the negation of all the values of the propositional variable <span class=\"mathmode\"><var>ξ<\/var><\/span>."
        ]
    },
    "5.503": {
        ...
        "PearsMcGuinness": [
            "It is obvious that we can easily express how propositions may be constructed with this operation, and how they may not be constructed with it; so it must be possible to find an exact expression for this."
        ]
    },
    "5.51": {
        "German": [
    ...
    "5.512": {
        ...
        "PearsMcGuinness": [
            "‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ is true if ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ is false. Therefore, in the proposition ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’, when it is true, ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ is a false proposition. How then can the stroke ‘~’ make it agree with reality?",
            "But in ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ it is not ‘~’ that negates, it is rather what is common to all the signs of this notation that negate <span class=\"mathmode\"><var>p<\/var><\/span>.",
            "That is to say the common rule that governs the construction of ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’, ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’, ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’, ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>p<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’, etc. etc. (ad inf.). And this common factor mirrors negation."
        ]
    },
    "5.513": {
        "German": [
        ...
        "PearsMcGuinness": [
            "We might say that what is common to all symbols that affirm both <span class=\"mathmode\"><var>p<\/var><\/span> and <span class=\"mathmode\"><var>q<\/var><\/span> is the proposition ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\">.<\/span><var>q<\/var><\/span>’; and that what is common to all symbols that affirm either <span class=\"mathmode\"><var>p<\/var><\/span> or <span class=\"mathmode\"><var>q<\/var><\/span> is the proposition ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><var>q<\/var><\/span>’.",
            ...
            "Thus in Russell’s notation too it is manifest that ‘<span class=\"mathmode\"><var>q<\/var><span class=\"mathrel\">:<\/span><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ says the same thing as ‘<span class=\"mathmode\"><var>q<\/var><\/span>’, that ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">∨<\/span><\/span><span class=\"mathop\">~<\/span><var>p<\/var><\/span>’ says nothing."
        ]
    },
    "5.514": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Once a notation has been established, there will be in it a rule governing the construction of all propositions that negate <span class=\"mathmode\"><var>p<\/var><\/span>, a rule governing the construction of all propositions that affirm <span class=\"mathmode\"><var>p<\/var><\/span>, and a rule governing the construction of all propositions that affirm <span class=\"mathmode\"><var>p<\/var><\/span> or <span class=\"mathmode\"><var>q<\/var><\/span>; and so on. These rules are equivalent to the symbols; and in them their sense is mirrored."
        ]
    },
    "5.515": {
        "German": [
    ...
    "5.52": {
        ...
        "PearsMcGuinness": [
            "If <span class=\"mathmode\"><var>ξ<\/var><\/span> has as its values all the values of a function <span class=\"mathmode\"><var>fx<\/var><\/span> for all values of <span class=\"mathmode\"><var>x<\/var><\/span>, then <span class=\"mathmode\"><span class=\"nop\">N<\/span>(<span class=\"overlined\"><var>ξ<\/var><\/span>)<span class=\"mathrel\">=<\/span><span class=\"mathop\">~<\/span><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>fx<\/var><\/span>."
        ]
    },
    "5.521": {
        "German": [
        ...
        "PearsMcGuinness": [
            "I dissociate the concept <em>all<\/em> from truth-functions.",
            "Frege and Russell introduced generality in association with logical product or logical sum. This made it difficult to understand the propositions ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>fx<\/var><\/span>’ and ‘<span class=\"mathmode\"><span class=\"quant\">(<var>x<\/var>).<\/span><var>fx<\/var><\/span>’, in which both ideas are embedded."
        ]
    },
    "5.522": {
        "German": [
        ...
        "PearsMcGuinness": [
            "What is peculiar to the generality-sign is first, that it indicates a logical prototype, and secondly, that it gives prominence to constants."
        ]
    },
    "5.523": {
        "German": [
    ...
    "5.524": {
        ...
        "PearsMcGuinness": [
            "If objects are given, then at the same time we are given <em>all<\/em> objects.",
            "If elementary propositions are given, then at the same time <em>all<\/em> elementary propositions are given."
        ]
    },
    "5.525": {
        "German": [
        ...
        "PearsMcGuinness": [
            "It is incorrect to render the proposition ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>fx<\/var><\/span>’ in the words, ‘<span class=\"mathmode\"><var>fx<\/var><\/span> is <em>possible<\/em>’ as Russell does.",
    ...
    "5.526": {
        ...
        "PearsMcGuinness": [
            "We can describe the world completely by means of fully generalized propositions, i.e. without first correlating any name with a particular object.",
            "Then, in order to arrive at the customary mode of expression, we simply need to add, after an expression like, ‘There is one and only one <span class=\"mathmode\"><var>x<\/var><\/span> such that …’, the words, ‘and that <span class=\"mathmode\"><var>x<\/var><\/span> is <span class=\"mathmode\"><var>a<\/var><\/span>’."
        ]
    },
    "5.5261": {
        "German": [
        ...
        "PearsMcGuinness": [
            "A fully generalized proposition, like every other proposition, is composite. (This is shown by the fact that in ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>, <var>φ<\/var>).<\/span><var>φx<\/var><\/span>’ we have to mention ‘<span class=\"mathmode\"><var>φ<\/var><\/span>’ and ‘<span class=\"mathmode\"><var>x<\/var><\/span>’ separately. They both, independently, stand in signifying relations to the world, just as is the case in ungeneralized propositions.)",
            "It is a mark of a composite symbol that it has something in common with <em>other<\/em> symbols."
        ]
    },
    "5.5262": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The truth or falsity of <em>every<\/em> proposition does make some alteration in the general construction of the world. And the range that the totality of elementary propositions leaves open for its construction is exactly the same as that which is delimited by entirely general propositions.",
            "(If an elementary proposition is true, that means, at any rate, one <em>more<\/em> true elementary proposition.)"
        ]
    },
    "5.53": {
        "German": [
    ...
    "5.5301": {
        ...
        "PearsMcGuinness": [
            "It is self-evident that identity is not a relation between objects. This becomes very clear if one considers, for example, the proposition ‘<span class=\"mathmode\"><span class=\"quant\">(<var>x<\/var>):<\/span><var>fx<\/var><span class=\"mathrel\">.<span class=\"symbol\">⊃<\/span>.<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><var>a<\/var><\/span>’. What this proposition says is simply that <em>only<\/em> <span class=\"mathmode\"><var>a<\/var><\/span> satisfies the function <span class=\"mathmode\"><var>f<\/var><\/span>, and not that only things that have a certain relation to <span class=\"mathmode\"><var>a<\/var><\/span> satisfy the function <span class=\"mathmode\"><var>f<\/var><\/span>.",
            "Of course, it might then be said that <em>only<\/em> <span class=\"mathmode\"><var>a<\/var><\/span> did have this relation to <span class=\"mathmode\"><var>a<\/var><\/span>; but in order to express that, we should need the identity-sign itself."
        ]
    },
    "5.5302": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Russell’s definition of ‘=’ is inadequate, because according to it we cannot say that two objects have all their properties in common. (Even if this proposition is never correct, it still has <em>sense<\/em>.)"
        ]
    },
    "5.5303": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Roughly speaking, to say of <em>two<\/em> things that they are identical is nonsense, and to say of <em>one<\/em> thing that it is identical with itself is to say nothing at all."
        ]
    },
    "5.531": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Thus I do not write ‘<span class=\"mathmode\"><var>f<\/var>(<var>a<\/var>,<var>b<\/var>)<span class=\"mathrel\">.<\/span><var>a<\/var><span class=\"mathrel\">=<\/span><var>b<\/var><\/span>’, but ‘<span class=\"mathmode\"><var>f<\/var>(<var>a<\/var>,<var>a<\/var>)<\/span>’ (or ‘<span class=\"mathmode\"><var>f<\/var>(<var>b<\/var>,<var>b<\/var>)<\/span>’); and not ‘<span class=\"mathmode\"><var>f<\/var>(<var>a<\/var>,<var>b<\/var>)<span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>a<\/var><span class=\"mathrel\">=<\/span><var>b<\/var><\/span>’, but ‘<span class=\"mathmode\"><var>f<\/var>(<var>a<\/var>,<var>b<\/var>)<\/span>’."
        ]
    },
    "5.532": {
        "German": [
        ...
        "PearsMcGuinness": [
            "And analogously I do not write ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>).<\/span><var>f<\/var>(<var>x<\/var>,<var>y<\/var>)<span class=\"mathrel\">.<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><var>y<\/var><\/span>’, but ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>f<\/var>(<var>x<\/var>,<var>x<\/var>)<\/span>’; and not ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>).<\/span><var>f<\/var>(<var>x<\/var>,<var>y<\/var>)<span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><var>y<\/var><\/span>’, but ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>).<\/span><var>f<\/var>(<var>x<\/var>,<var>y<\/var>)<\/span>’.",
            "(So Russell’s ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>).<\/span><var>f<\/var>(<var>x<\/var>,<var>y<\/var>)<\/span>’ becomes ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>).<\/span><var>f<\/var>(<var>x<\/var>,<var>y<\/var>)<span class=\"mathrel\">.<span class=\"symbol\">∨<\/span>.<\/span><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>f<\/var>(<var>x<\/var>,<var>x<\/var>)<\/span>’.)"
        ]
    },
    "5.5321": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "And the proposition, ‘<em>Only one<\/em> <span class=\"mathmode\"><var>x<\/var><\/span> satisfies <span class=\"mathmode\"><var>f<\/var>(&nbsp;)<\/span>’, will read ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>fx<\/var><span class=\"mathrel\">:<\/span><span class=\"mathop\">~<\/span><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>,<var>y<\/var>).<\/span><var>fx<\/var><span class=\"mathrel\">.<\/span><var>fy<\/var><\/span>’."
        ]
    },
    "5.533": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The identity-sign, therefore, is not an essential constituent of conceptual notation."
        ]
    },
    "5.534": {
        "German": [
        ...
        "PearsMcGuinness": [
            "And now we see that in a correct conceptual notation pseudo-propositions like ‘<span class=\"mathmode\"><var>a<\/var><span class=\"mathrel\">=<\/span><var>a<\/var><\/span>’, ‘<span class=\"mathmode\"><var>a<\/var><span class=\"mathrel\">=<\/span><var>b<\/var><span class=\"mathrel\">.<\/span><var>b<\/var><span class=\"mathrel\">=<\/span><var>c<\/var><span class=\"mathrel\">.<span class=\"symbol\">⊃<\/span><\/span><var>a<\/var><span class=\"mathrel\">=<\/span><var>c<\/var><\/span>’, ‘<span class=\"mathmode\"><span class=\"quant\">(<var>x<\/var>).<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><var>x<\/var><\/span>’, ‘<span class=\"mathmode\"><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><var>a<\/var><\/span>’, etc. cannot even be written down."
        ]
    },
    "5.535": {
        "German": [
        ...
        "PearsMcGuinness": [
            "This also disposes of all the problems that were connected with such pseudo-propositions.",
    ...
    "5.5351": {
        ...
        "PearsMcGuinness": [
            "There are certain cases in which one is tempted to use expressions of the form ‘<span class=\"mathmode\"><var>a<\/var><span class=\"mathrel\">=<\/span><var>a<\/var><\/span>’ or ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>p<\/var><\/span>’ and the like. In fact, this happens when one wants to talk about prototypes, e.g. about proposition, thing, etc. Thus in Russell’s <em>Principles of Mathematics<\/em> ‘<span class=\"mathmode\"><var>p<\/var><\/span> is a proposition’—which is nonsense—was given the symbolic rendering ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>p<\/var><\/span>’ and placed as an hypothesis in front of certain propositions in order to exclude from their argument-places everything but propositions.",
    ...
    "5.5352": {
        ...
        "PearsMcGuinness": [
            "In the same way people have wanted to express, ‘There are no <em>things<\/em>’, by writing ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><span class=\"quant\">(<span class=\"symbol\">∃<\/span><var>x<\/var>).<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><var>x<\/var><\/span>’. But even if this were a proposition, would it not be equally true if in fact ‘there were things’ but they were not identical with themselves?"
        ]
    },
    "5.54": {
        "German": [
    ...
    "5.541": {
        ...
        "PearsMcGuinness": [
            ...
            "Particularly with certain forms of proposition in psychology, such as ‘A believes that <span class=\"mathmode\"><var>p<\/var><\/span> is the case’ and A has the thought <span class=\"mathmode\"><var>p<\/var><\/span>’, etc.",
            "For if these are considered superficially, it looks as if the proposition <span class=\"mathmode\"><var>p<\/var><\/span> stood in some kind of relation to an object A.",
    ...
    "5.542": {
        ...
        "PearsMcGuinness": [
            "It is clear, however, that ‘A believes that <span class=\"mathmode\"><var>p<\/var><\/span>’, ‘A has the thought <span class=\"mathmode\"><var>p<\/var><\/span>’, and ‘A says <span class=\"mathmode\"><var>p<\/var><\/span>’ are of the form ‘“<span class=\"mathmode\"><var>p<\/var><\/span>” says <span class=\"mathmode\"><var>p<\/var><\/span>’: and this does not involve a correlation of a fact with an object, but rather the correlation of facts by means of the correlation of their objects."
        ]
    },
    "5.5421": {
        "German": [
        ...
        "PearsMcGuinness": [
            "This shows too that there is no such thing as the soul—the subject, etc.—as it is conceived in the superficial psychology of the present day.",
    ...
    "5.5422": {
        ...
        "PearsMcGuinness": [
            "The correct explanation of the form of the proposition, ‘A makes the judgement <span class=\"mathmode\"><var>p<\/var><\/span>’, must show that it is impossible for a judgement to be a piece of nonsense. (Russell’s theory does not satisfy this requirement.)"
        ]
    },
    "5.5423": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "<!-- noindent --><div class=\"centered\"><object data=\"images\/thecube.svg\" type=\"image\/svg+xml\" class=\"thecubesvg\" ><img src=\"images\/thecube.png\" alt=\"Cube with a face and b face\" class=\"thecubepng\" \/><\/object><\/div>",
            "<!-- noindent --> as a cube; and all similar phenomena. For we really see two different facts.",
            "(If I look in the first place at the corners marked <span class=\"mathmode\"><var>a<\/var><\/span> and only glance at the <span class=\"mathmode\"><var>b<\/var><\/span>’s, then the <span class=\"mathmode\"><var>a<\/var><\/span>’s appear to be in front, and <em>vice versa<\/em>)."
        ]
    },
    "5.55": {
        "German": [
        ...
        "PearsMcGuinness": [
            "We now have to answer <em>a priori<\/em> the question about all the possible forms of elementary propositions.",
    ...
    "5.552": {
        ...
        "PearsMcGuinness": [
            "The ‘experience’ that we need in order to understand logic is not that something or other is the state of things, but that something <em>is<\/em>: that, however, is <em>not<\/em> an experience.",
            "Logic is <em>prior<\/em> to every experience—that something <em>is so<\/em>.",
    ...
    "5.5521": {
        ...
        "PearsMcGuinness": [
            "And if this were not so, how could we apply logic? We might put it in this way: if there would be a logic even if there were no world, how then could there be a logic given that there is a world?"
        ]
    },
    "5.553": {
        "German": [
    ...
    "5.5541": {
        ...
        "PearsMcGuinness": [
            "It is supposed to be possible to answer <em>a priori<\/em> the question whether I can get into a position in which I need the sign for a 27-termed relation in order to signify something."
        ]
    },
    "5.5542": {
        "German": [
        ...
        "PearsMcGuinness": [
            "But is it really legitimate even to ask such a question? Can we set up a form of sign without knowing whether anything can correspond to it?",
            "Does it make sense to ask what there must <em>be<\/em> in order that something can be the case?"
        ]
    },
    "5.555": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Clearly we have some concept of elementary propositions quite apart from their particular logical forms.",
    ...
    "5.5563": {
        ...
        "PearsMcGuinness": [
            "In fact, all the propositions of our everyday language, just as they stand, are in perfect logical order.—That utterly simple thing, which we have to formulate here, is not an image of the truth, but the truth itself in its entirety.",
            "(Our problems are not abstract, but perhaps the most concrete that there are.)"
        ]
    },
    "5.557": {
    ...
    "5.5571": {
        ...
        "PearsMcGuinness": [
            "If I cannot say <em>a priori<\/em> what elementary propositions there are, then the attempt to do so must lead to obvious nonsense."
        ]
    },
    "5.6": {
        "German": [
    ...
    "5.61": {
        ...
        "PearsMcGuinness": [
            ...
            "We cannot think what we cannot think; so what we cannot think we cannot <em>say<\/em> either."
        ]
    },
    "5.62": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "For what the solipsist <em>means<\/em> is quite correct; only it cannot be <em>said<\/em>, but makes itself manifest.",
            "The world is <em>my<\/em> world: this is manifest in the fact that the limits of <em>language<\/em> (of that language which alone I understand) mean the limits of <em>my<\/em> world."
        ]
    },
    "5.621": {
        "German": [
    ...
    "5.631": {
        ...
        "PearsMcGuinness": [
            ...
            "If I wrote a book called <em>The World as I found it<\/em>, I should have to include a report on my body, and should have to say which parts were subordinate to my will, and which were not, etc., this being a method of isolating the subject, or rather of showing that in an important sense there is no subject; for it alone could <em>not<\/em> be mentioned in that book.—"
        ]
    },
    "5.632": {
        "German": [
    ...
    "5.633": {
        ...
        "PearsMcGuinness": [
            "Where <em>in<\/em> the world is a metaphysical subject to be found?",
            "You will say that this is exactly like the case of the eye and the visual field. But really you do <em>not<\/em> see the eye.",
            "And nothing <em>in the visual field<\/em> allows you to infer that it is seen by an eye."
        ]
    },
    "5.6331": {
        "German": [
    ...
    "5.634": {
        ...
        "PearsMcGuinness": [
            "This is connected with the fact that no part of our experience is at the same time <em>a priori<\/em>.",
            "Whatever we see could be other than it is.",
            "Whatever we can describe at all could be other than it is.",
            "There is no <em>a priori<\/em> order of things."
        ]
    },
    "5.64": {
        "German": [
    ...
    "6": {
        ...
        "PearsMcGuinness": [
            "The general form of a truth-function is  <span class=\"mathmode\">[<span class=\"overlined\"><var>p<\/var><\/span>, <span class=\"overlined\"><var>ξ<\/var><\/span>, <span class=\"nop\">N<\/span>(<span class=\"overlined\"><var>ξ<\/var><\/span>)]<\/span>.",
    ...
    "6.001": {
        ...
        "PearsMcGuinness": [
            "What this says is just that every proposition is a result of successive applications to elementary propositions of the operation <span class=\"mathmode\"><span class=\"nop\">N<\/span>(<span class=\"overlined\"><var>ξ<\/var><\/span>)<\/span>."
        ]
    },
    "6.002": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If we are given the general form according to which propositions are constructed, then with it we are also given the general form according to which one proposition can be generated out of another by means of an operation."
        ]
    },
    "6.01": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Therefore the general form of an operation <span class=\"mathmode\"><span class=\"mathop\">Ω’<\/span>(<span class=\"overlined\"><var>η<\/var><\/span>)<\/span> is <span class=\"mathmode\"><span class=\"mathop\">[<span class=\"overlined\"><var>ξ<\/var><\/span>, <span class=\"nop\">N<\/span>(<span class=\"overlined\"><var>ξ<\/var><\/span>)]’<\/span> (<span class=\"overlined\"><var>η<\/var><\/span>) (<span class=\"mathrel\">=<\/span>[<span class=\"overlined\"><var>η<\/var><\/span>, <span class=\"overlined\"><var>ξ<\/var><\/span>, <span class=\"nop\">N<\/span>(<span class=\"overlined\"><var>ξ<\/var><\/span>)])<\/span>.",
            "This is the most general form of transition from one proposition to another."
        ]
    },
    "6.02": {
        ...
        "PearsMcGuinness": [
            "And <em>this<\/em> is how we arrive at numbers. I give the following definitions",
            "<div class=\"centered\"><table class=\"alignedmath\"><tr><td class=\"righttight\"><span class=\"mathmode\"><var>x<\/var><span class=\"mathrel\">=<\/span><\/span><\/td><td class=\"lefttight\"><span class=\"mathmode\"><span class=\"mathop\">Ω<sup>0<\/sup>’<\/span><var>x<\/var><\/span>&nbsp;&nbsp;Def.,<\/td><\/tr><tr><td class=\"righttight\"><span class=\"mathmode\"><span class=\"mathop\">Ω’<\/span><span class=\"mathop\">Ω<sup><var>ν<\/var><\/sup>’<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><\/span><\/td><td class=\"lefttight\"><span class=\"mathmode\"><span class=\"mathop\">Ω<sup><var>ν<\/var>+1<\/sup>’<\/span><var>x<\/var><\/span>&nbsp;&nbsp;Def.<\/td><\/tr><\/table><\/div>",
            "So, in accordance with these rules, which deal with signs, we write the series",
            "<div class=\"centered\"><span class=\"mathmode\"><var>x<\/var>, <span class=\"mathop\">Ω’<\/span><var>x<\/var>, <span class=\"mathop\">Ω’<\/span><span class=\"mathop\">Ω’<\/span><var>x<\/var>, <span class=\"mathop\">Ω’<\/span><span class=\"mathop\">Ω’<\/span><span class=\"mathop\">Ω’<\/span><var>x<\/var>,<span class=\"mathrel\">…<\/span><\/span><\/div><span class=\"mathmode\"><\/span>",
            "in the following way",
            "<div class=\"centered\"><span class=\"mathmode\"><span class=\"mathop\">Ω<sup>0<\/sup>’<\/span><var>x<\/var>, <span class=\"mathop\">Ω<sup>0<span class=\"mathrel\">+<\/span>1<\/sup>’<\/span><var>x<\/var>, <span class=\"mathop\">Ω<sup>0<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<\/sup>’<\/span><var>x<\/var>, <span class=\"mathop\">Ω<sup>0<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<\/sup>’<\/span><var>x<\/var>,<span class=\"mathrel\">…<\/span><\/span><\/div><span class=\"mathmode\"><\/span>",
            "Therefore, instead of ‘<span class=\"mathmode\">[<var>x<\/var>, <var>ξ<\/var>, <span class=\"mathop\">Ω’<\/span><var>ξ<\/var>]<\/span>’,",
            "<div class=\"centered\"><span class=\"mathmode\"><span class=\"mathrm\">I write<\/span>  &nbsp; ‘[<span class=\"mathop\">Ω<sup>0<\/sup>’<\/span><var>x<\/var>, <span class=\"mathop\">Ω<sup><var>ν<\/var><\/sup>’<\/span><var>x<\/var>, <span class=\"mathop\">Ω<sup><var>ν<\/var><span class=\"mathrel\">+<\/span>1<\/sup>’<\/span><var>x<\/var>]’.<\/span><\/div><span class=\"mathmode\"><\/span>",
            "And I give the following definitions",
            "<div class=\"centered\"><table class=\"alignedmath\"><tr><td class=\"righttight\"><span class=\"mathmode\">0<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">=<\/span><\/span><\/td><td class=\"lefttight\"><span class=\"mathmode\">1<\/span>&nbsp;&nbsp;Def.,<\/td><\/tr><tr><td class=\"righttight\"><span class=\"mathmode\">0<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">=<\/span><\/span><\/td><td class=\"lefttight\"><span class=\"mathmode\">2<\/span>&nbsp;&nbsp;Def.,<\/td><\/tr><tr><td class=\"righttight\"><span class=\"mathmode\">0<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">=<\/span><\/span><\/td><td class=\"lefttight\"><span class=\"mathmode\">3<\/span>&nbsp;&nbsp;Def.,<\/td><\/tr><tr><td class=\"centertight\" colspan=\"2\">(and so on).<\/td><\/tr><\/table><\/div>"
        ]
    },
    "6.021": {
        "German": [
    ...
    "6.022": {
        ...
        "PearsMcGuinness": [
            "The concept of number is simply what is common to all numbers, the general form of a number.",
    ...
    "6.03": {
        ...
        "PearsMcGuinness": [
            "The general form of an integer is <span class=\"mathmode\">[0, <var>ξ<\/var>, <var>ξ<\/var><span class=\"mathrel\">+<\/span>1]<\/span>."
        ]
    },
    "6.031": {
        "German": [
        ...
        "PearsMcGuinness": [
            ...
            "This is connected with the fact that the generality required in mathematics is not <em>accidental<\/em> generality."
        ]
    },
    "6.1": {
        "German": [
    ...
    "6.113": {
        "German": [
            "Es ist das besondere Merkmal der logischen Sätze, dass man am Symbol allein erkennen kann, dass sie wahr sind, und diese Tatsache schließt die ganze Philosophie der Logik in sich. Und so ist es auch eine der wichtigsten Tatsachen, dass sich die Wahrheit oder Falschheit der nichtlogischen Sätze <em class=\"germph\">nicht<\/em> am Satz allein erkennen lässt."
        ],
        "Ogden": [
    ...
    "6.12": {
        ...
        "PearsMcGuinness": [
            "The fact that the propositions of logic are tautologies <em>shows<\/em> the formal—logical—properties of language and the world.",
            "The fact that a tautology is yielded by <em>this particular way<\/em> of connecting its constituents characterizes the logic of its constituents.",
            "If propositions are to yield a tautology when they are connected in a certain way, they must have certain structural properties. So their yielding a tautology when combined <em>in this way<\/em> shows that they possess these structural properties."
        ]
    },
    "6.1201": {
        "German": [
    ...
    "6.1203": {
        ...
        "PearsMcGuinness": [
            "In order to recognize an expression as a tautology, in cases where no generality-sign occurs in it, one can employ the following intuitive method: instead of ‘<span class=\"mathmode\"><var>p<\/var><\/span>’, ‘<span class=\"mathmode\"><var>q<\/var><\/span>’, ‘<span class=\"mathmode\"><var>r<\/var><\/span>’, etc. I write ‘<span class=\"mathmode\"><span class=\"mathrm\">T<\/span> <var>p<\/var> <span class=\"mathrm\">F<\/span><\/span>’, ‘<span class=\"mathmode\"><span class=\"mathrm\">T<\/span> <var>q<\/var> <span class=\"mathrm\">F<\/span><\/span>’, ‘<span class=\"mathmode\"><span class=\"mathrm\">T<\/span> <var>r<\/var> <span class=\"mathrm\">F<\/span><\/span>’, etc. Truth-combinations I express by means of brackets, e.g.",
            "<!-- noindent --><div class=\"centered\"><object data=\"images\/abfigureoneenglishpmc.svg\" type=\"image\/svg+xml\" width=\"157\" height=\"69\" style=\"width: 157pt; height: 69pt;\"><img src=\"images\/abfigureoneenglishpmc.png\" alt=\"[TF figure]\" \/><\/object><\/div>",
            "<!-- noindent --> and I use lines to express the correlation of the truth or falsity of the whole proposition with the truth-combinations of its truth-arguments, in the following way",
            "<!-- noindent --><div class=\"centered\"><object data=\"images\/abfiguretwoenglishpmc.svg\" type=\"image\/svg+xml\" width=\"157\" height=\"124\" style=\"width: 157pt; height: 124pt;\"><img src=\"images\/abfiguretwoenglishpmc.png\" alt=\"[TF figure]\" \/><\/object><\/div>",
            "<!-- noindent --> So this sign, for instance, would represent the proposition <span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>q<\/var><\/span>. Now, by way of example, I wish to examine the proposition <span class=\"mathmode\"><span class=\"mathop\">~<\/span>(<var>p<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>p<\/var>)<\/span> (the law of contradiction) in order to determine whether it is a tautology. In our notation the form ‘<span class=\"mathmode\"><span class=\"mathop\">~<\/span><var>ξ<\/var><\/span>’ is written as",
            "<!-- noindent --><div class=\"centered\"><object data=\"images\/abfigurethreeenglishpmc.svg\" type=\"image\/svg+xml\" width=\"46\" height=\"75\" style=\"width: 46pt; height: 75pt;\"><img src=\"images\/abfigurethreeenglishpmc.png\" alt=\"[TF figure]\" \/><\/object><\/div>",
            "<!-- noindent --> and the form ‘<span class=\"mathmode\"><var>ξ<\/var><span class=\"mathrel\">.<\/span><var>η<\/var><\/span>’ as",
            "<!-- noindent --><div class=\"centered\"><object data=\"images\/abfigurefourenglishpmc.svg\" type=\"image\/svg+xml\" width=\"157\" height=\"116\" style=\"width: 157pt; height: 116pt;\"><img src=\"images\/abfigurefourenglishpmc.png\" alt=\"[TF figure]\" \/><\/object><\/div>",
            "<!-- noindent --> Hence the proposition <span class=\"mathmode\"><span class=\"mathop\">~<\/span>(<var>p<\/var><span class=\"mathrel\">.<\/span><span class=\"mathop\">~<\/span><var>q<\/var>)<\/span> reads as follows",
            "<!-- noindent --><div class=\"centered\"><object data=\"images\/abfigurefiveenglishpmc.svg\" type=\"image\/svg+xml\" width=\"129\" height=\"168\" style=\"width: 129pt; height: 168pt;\"><img src=\"images\/abfigurefiveenglishpmc.png\" alt=\"[TF figure]\" \/><\/object><\/div>",
            "<!-- noindent --> If we here substitute ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ for ‘<span class=\"mathmode\"><var>q<\/var><\/span>’ and examine how the outermost T and F are connected with the innermost ones, the result will be that the truth of the whole proposition is correlated with <em>all<\/em> the truth-combinations of its argument, and its falsity with none of the truth-combinations."
        ]
    },
    "6.121": {
        "German": [
    ...
    "6.122": {
        ...
        "PearsMcGuinness": [
            "It follows from this that we can actually do without logical propositions; for in a suitable notation we can in fact recognize the formal properties of propositions by mere inspection of the propositions themselves."
        ]
    },
    "6.1221": {
        "German": [
        ...
        "PearsMcGuinness": [
            "If, for example, two propositions ‘<span class=\"mathmode\"><var>p<\/var><\/span>’ and ‘<span class=\"mathmode\"><var>q<\/var><\/span>’ in the combination ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>q<\/var><\/span>’ yield a tautology, then it is clear that <span class=\"mathmode\"><var>q<\/var><\/span> follows from <span class=\"mathmode\"><var>p<\/var><\/span>.",
            "For example, we see from the two propositions themselves that ‘<span class=\"mathmode\"><var>q<\/var><\/span>’ follows from ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>q<\/var><span class=\"mathrel\">.<\/span><var>p<\/var><\/span>’, but it is also possible to show it in <em>this<\/em> way: we combine them to form ‘<span class=\"mathmode\"><var>p<\/var><span class=\"mathrel\"><span class=\"symbol\">⊃<\/span><\/span><var>q<\/var><span class=\"mathrel\">.<\/span><var>p<\/var><span class=\"mathrel\">:<span class=\"symbol\">⊃<\/span>:<\/span><var>q<\/var><\/span>’, and then show that this is a tautology."
        ]
    },
    "6.1222": {
        "German": [
    ...
    "6.1223": {
        ...
        "PearsMcGuinness": [
            "Now it becomes clear why people have often felt as if it were for us to ‘<em>postulate<\/em>’ the ‘truths of logic’. The reason is that we can postulate them in so far as we can postulate an adequate notation."
        ]
    },
    "6.1224": {
        "German": [
        ...
        "PearsMcGuinness": [
            "It also becomes clear now why logic was called the theory of forms and of inference."
        ]
    },
    "6.123": {
        "German": [
    ...
    "6.1231": {
        ...
        "PearsMcGuinness": [
            "The mark of a logical proposition is <em>not<\/em> general validity.",
    ...
    "6.126": {
        ...
        "PearsMcGuinness": [
            "One can calculate whether a proposition belongs to logic, by calculating the logical properties of the <em>symbol<\/em>.",
            "And this is what we do when we ‘prove’ a logical proposition. For, without bothering about sense or meaning, we construct the logical proposition out of others using only <em>rules that deal with signs<\/em>.",
            "The proof of logical propositions consists in the following process: we produce them out of other logical propositions by successively applying certain operations that always generate further tautologies out of the initial ones. (And in fact only tautologies <em>follow<\/em> from a tautology.)",
    ...
    "6.1263": {
        ...
        "PearsMcGuinness": [
            "Indeed, it would be altogether too remarkable if a proposition that had sense could be proved <em>logically<\/em> from others, and <em>so too<\/em> could a logical proposition. It is clear from the start that a logical proof of a proposition that has sense and a proof <em>in<\/em> logic must be two entirely different things."
        ]
    },
    "6.1264": {
        "German": [
        ...
        "PearsMcGuinness": [
            "A proposition that has sense states something, which is shown by its proof to be so. In logic every proposition is the form of a proof.",
            "Every proposition of logic is a <em>modus ponens<\/em> represented in signs. (And one cannot express the <em>modus ponens<\/em> by means of a proposition.)"
        ]
    },
    "6.1265": {
        "German": [
    ...
    "6.127": {
        ...
        "PearsMcGuinness": [
            "All the propositions of logic are of equal status: it is not the case that some of them are essentially derived propositions.",
            "Every tautology itself shows that it is a tautology."
        ]
    },
    "6.1271": {
    ...
    "6.211": {
        ...
        "PearsMcGuinness": [
            "Indeed in real life a mathematical proposition is never what we want. Rather, we make use of mathematical propositions <em>only<\/em> in inferences from propositions that do not belong to mathematics to others that likewise do not belong to mathematics.",
    ...
    "6.23": {
        ...
        "PearsMcGuinness": [
            "If two expressions are combined by means of the sign of equality, that means that they can be substituted for one another. But it must be manifest in the two expressions themselves whether this is the case or not.",
    ...
    "6.231": {
        ...
        "PearsMcGuinness": [
            ...
            "It is a property of ‘<span class=\"mathmode\">1<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<\/span>’ that it can be construed as ‘<span class=\"mathmode\">(1<span class=\"mathrel\">+<\/span>1)<span class=\"mathrel\">+<\/span>(1<span class=\"mathrel\">+<\/span>1)<\/span>’."
        ]
    },
    "6.232": {
        "German": [
    ...
    "6.2322": {
        ...
        "PearsMcGuinness": [
            "It is impossible to <em>assert<\/em> the identity of meaning of two expressions. For in order to be able to assert anything about their meaning, I must know their meaning, and I cannot know their meaning without knowing whether what they mean is the same or different."
        ]
    },
    "6.2323": {
        "German": [
    ...
    "6.2331": {
        ...
        "PearsMcGuinness": [
            "The process of <em>calculating<\/em> serves to bring about that intuition.",
            "Calculation is not an experiment."
        ]
    },
    "6.234": {
    ...
    "6.2341": {
        ...
        "PearsMcGuinness": [
            "It is the essential characteristic of mathematical method that it employs equations. For it is because of this method that every proposition of mathematics must go without saying."
        ]
    },
    "6.24": {
        "German": [
    ...
    "6.241": {
        ...
        "PearsMcGuinness": [
            "Thus the proof of the proposition <span class=\"mathmode\">2 × 2<span class=\"mathrel\">=<\/span>4<\/span> runs as follows:",
            "<div class=\"centered\"><span class=\"mathmode\"><span class=\"mathop\">(Ω<sup><var>ν<\/var><\/sup>)<sup><var>μ<\/var><\/sup>’<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><span class=\"mathop\">Ω<sup><var>ν<\/var>× <var>μ<\/var><\/sup>’<\/span><var>x<\/var><\/span> Def.<br \/>\n<span class=\"mathmode\"><span class=\"mathop\">Ω<sup>2 × 2<\/sup>’<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><span class=\"mathop\">(Ω<sup>2<\/sup>)<sup>2<\/sup>’<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><span class=\"mathop\">(Ω<sup>2<\/sup>)<sup>1<span class=\"mathrel\">+<\/span>1<\/sup>’<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><span class=\"mathop\">Ω<sup>2<\/sup>’<\/span><span class=\"mathop\">Ω<sup>2<\/sup>’<\/span><var>x<\/var><\/span><br \/>\n<span class=\"mathmode\"><span class=\"mathrel\">=<\/span><span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+<\/span>1<\/sup>’<\/span><span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+<\/span>1<\/sup>’<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><span class=\"mathop\">(Ω’Ω)’<\/span><span class=\"mathop\">(Ω’Ω)’<\/span> <var>x<\/var><\/span><br \/>\n<span class=\"mathmode\"><span class=\"mathrel\">=<\/span><span class=\"mathop\">Ω’<\/span><span class=\"mathop\">Ω’<\/span><span class=\"mathop\">Ω’<\/span><span class=\"mathop\">Ω’<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<span class=\"mathrel\">+<\/span>1<\/sup>’<\/span><var>x<\/var><span class=\"mathrel\">=<\/span><span class=\"mathop\">Ω<sup>4<\/sup>’<\/span><var>x<\/var><\/span>.<br \/>\n<\/div>"
        ]
    },
    "6.3": {
        ...
        "PearsMcGuinness": [
            "The exploration of logic means the exploration of <em>everything that is subject to law<\/em>. And outside logic everything is accidental."
        ]
    },
    "6.31": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The so-called law of induction cannot possibly be a law of logic, since it is obviously a proposition with sense.—Nor, therefore, can it be an <em>a priori<\/em> law."
        ]
    },
    "6.32": {
        "German": [
    ...
    "6.3211": {
        ...
        "PearsMcGuinness": [
            "Indeed people even surmised that there must be a ‘law of least action’ before they knew exactly how it went. (Here, as always, what is certain <em>a priori<\/em> proves to be something purely logical.)"
        ]
    },
    "6.33": {
        "German": [
        ...
        "PearsMcGuinness": [
            "We do not have an <em>a priori belief<\/em> in a law of conservation, but rather <em>a priori knowledge<\/em> of the possibility of a logical form."
        ]
    },
    "6.34": {
        "German": [
        ...
        "PearsMcGuinness": [
            "All such propositions, including the principle of sufficient reason, the laws of continuity in nature and of least effort in nature, etc. etc.—all these are <em>a priori<\/em> insights about the forms in which the propositions of science can be cast."
        ]
    },
    "6.341": {
        "German": [
    ...
    "6.342": {
        ...
        "PearsMcGuinness": [
            "And now we can see the relative position of logic and mechanics. (The net might also consist of more than one kind of mesh: e.g. we could use both triangles and hexagons.) The possibility of describing a picture like the one mentioned above with a net of a given form tells us <em>nothing<\/em> about the picture. (For that is true of all such pictures.) But what <em>does<\/em> characterize the picture is that it can be described <em>completely<\/em> by a particular net with a <em>particular<\/em> size of mesh.",
            "Similarly the possibility of describing the world by means of Newtonian mechanics tells us nothing about the world: but what does tell us something about it is the precise <em>way<\/em> in which it is possible to describe it by these means. We are also told something about the world by the fact that it can be described more simply with one system of mechanics than with another."
        ]
    },
    "6.343": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Mechanics is an attempt to construct according to a single plan all the <em>true<\/em> propositions that we need for the description of the world."
        ]
    },
    "6.3431": {
        "German": [
    ...
    "6.3432": {
        ...
        "PearsMcGuinness": [
            "We ought not to forget that any description of the world by means of mechanics will be of the completely general kind. For example, it will never mention <em>particular<\/em> point-masses: it will only talk about <em>any point-masses whatsoever<\/em>."
        ]
    },
    "6.35": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Although the spots in our picture are geometrical figures, nevertheless geometry can obviously say nothing at all about their actual form and position. The network, however, is <em>purely<\/em> geometrical; all its properties can be given <em>a priori<\/em>.",
    ...
    "6.361": {
        ...
        "PearsMcGuinness": [
            "One might say, using Hertz’s terminology, that only connexions that are <em>subject to law<\/em> are <em>thinkable<\/em>."
        ]
    },
    "6.3611": {
        "German": [
        ...
        "PearsMcGuinness": [
            "We cannot compare a process with ‘the passage of time’—there is no such thing—but only with another process (such as the working of a chronometer).",
    ...
    "6.36111": {
        ...
        "PearsMcGuinness": [
            ...
            "<!-- noindent --><div class=\"centeredsqueeze\" ><b>–&nbsp;–&nbsp;–&nbsp;<span class=\"tight\"><span class=\"symbol\">○<\/span>————<span class=\"nudgedown\"><span class=\"symbol\">✕<\/span><\/span><\/span>&nbsp;–&nbsp;–&nbsp;<span class=\"tight\"><span class=\"nudgedown\"><span class=\"symbol\">✕<\/span><\/span>————<span class=\"symbol\">○<\/span><\/span>&nbsp;–&nbsp;–&nbsp;–<\/b><br \/><var class=\"smallvar\">a<\/var>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<var class=\"smallvar\">b<\/var><\/div>",
            "<!-- noindent --> in which the two congruent figures, <span class=\"mathmode\"><var>a<\/var><\/span> and <span class=\"mathmode\"><var>b<\/var><\/span>, cannot be made to coincide unless they are moved out of this space. The right hand and the left hand are in fact completely congruent. It is quite irrelevant that they cannot be made to coincide.",
    ...
    "6.363": {
        ...
        "PearsMcGuinness": [
            "The procedure of induction consists in accepting as true the <em>simplest<\/em> law that can be reconciled with our experiences."
        ]
    },
    "6.3631": {
        "German": [
    ...
    "6.36311": {
        ...
        "PearsMcGuinness": [
            "It is an hypothesis that the sun will rise tomorrow: and this means that we do not <em>know<\/em> whether it will rise."
        ]
    },
    "6.37": {
        "German": [
        ...
        "PearsMcGuinness": [
            "There is no compulsion making one thing happen because another has happened. The only necessity that exists is <em>logical<\/em> necessity"
        ]
    },
    "6.371": {
        "German": [
    ...
    "6.372": {
        ...
        "PearsMcGuinness": [
            ...
            "And in fact both are right and both wrong: though the view of the ancients is clearer in so far as they have a clear and acknowledged terminus, while the modern system tries to make it look as if <em>everything<\/em> were explained."
        ]
    },
    "6.373": {
        "German": [
    ...
    "6.374": {
        ...
        "PearsMcGuinness": [
            "Even if all that we wish for were to happen, still this would only be a favour granted by fate, so to speak: for there is no <em>logical<\/em> connexion between the will and the world, which would guarantee it, and the supposed physical connexion itself is surely not something that we could will."
        ]
    },
    "6.375": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Just as the only necessity that exists is <em>logical<\/em> necessity, so too the only impossibility that exists is <em>logical<\/em> impossibility."
        ]
    },
    "6.3751": {
        "German": [
    ...
    "6.41": {
        ...
        "PearsMcGuinness": [
            "The sense of the world must lie outside the world. In the world everything is as it is, and everything happens as it does happen: <em>in<\/em> it no value exists—and if it did exist, it would have no value.",
            "If there is any value that does have value, it must lie outside the whole sphere of what happens and is the case. For all that happens and is the case is accidental.",
            "What makes it non-accidental cannot lie <em>within<\/em> the world, since if it did it would itself be accidental.",
            "It must lie outside the world."
        ]
    },
    "6.42": {
    ...
    "6.4312": {
        ...
        "PearsMcGuinness": [
            "Not only is there no guarantee of the temporal immortality of the human soul, that is to say of its eternal survival after death; but, in any case, this assumption completely fails to accomplish the purpose for which it has always been intended. Or is some riddle solved by my surviving for ever? Is not this eternal life itself as much of a riddle as our present life? The solution of the riddle of life in space and time lies <em>outside<\/em> space and time.",
    ...
    "6.432": {
        ...
        "PearsMcGuinness": [
            "<em>How<\/em> things are in the world is a matter of complete indifference for what is higher. God does not reveal himself <em>in<\/em> the world."
        ]
    },
    "6.4321": {
        "German": [
    ...
    "6.44": {
        ...
        "PearsMcGuinness": [
            "It is not <em>how<\/em> things are in the world that is mystical, but <em>that<\/em> it exists."
        ]
    },
    "6.45": {
        "German": [
    ...
    "6.5": {
        ...
        "PearsMcGuinness": [
            ...
            "<em>The riddle<\/em> does not exist.",
            "If a question can be framed at all, it is also <em>possible<\/em> to answer it."
        ]
    },
    "6.51": {
        "German": [
        ...
        "PearsMcGuinness": [
            "Scepticism is <em>not<\/em> irrefutable, but obviously nonsensical, when it tries to raise doubts where no questions can be asked.",
            "For doubt can exist only where a question exists, a question only where an answer exists, and an answer only where something <em>can be said<\/em>."
        ]
    },
    "6.52": {
        "German": [
        ...
        "PearsMcGuinness": [
            "We feel that even when <em>all possible<\/em> scientific questions have been answered, the problems of life remain completely untouched. Of course there are then no questions left, and this itself is the answer."
        ]
    },
    "6.521": {
        "German": [
    ...
    "6.522": {
        ...
        "PearsMcGuinness": [
            "There are, indeed, things that cannot be put into words. They <em>make themselves manifest<\/em>. They are what is mystical."
        ]
    },
    "6.53": {
        "German": [
        ...
        "PearsMcGuinness": [
            "The correct method in philosophy would really be the following: to say nothing except what can be said, i.e. propositions of natural science—i.e. something that has nothing to do with philosophy—and then, whenever someone else wanted to say something metaphysical, to demonstrate to him that he had failed to give a meaning to certain signs in his propositions. Although it would not be satisfying to the other person—he would not have the feeling that we were teaching him philosophy—<em>this<\/em> method would be the only strictly correct one."
        ]
    },
    "6.54": {
        "German": [
